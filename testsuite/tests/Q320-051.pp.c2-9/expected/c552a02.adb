...
procedure C552a02 is
   ...
   function Get_Constant_Sparse_Data return Sparse_Integer_Arrays.Sparse_Array
   is
   begin
...
begin
   ...
   if F552a00_Bingo_Balls.Tc_Call_History /=
     "I1H:T( 1)N( 2)H:T( 2)N( 3)H:T( 3)N( 4)" &
       ...
       "N( 73)H:T( 73)N( 74)H:T( 74)N( 75)H:T( 75)N( 76)H:F( 76)"
   then
      Report.Failed
        (Descr =>
           "1) Unexpected Call History:" &
   ...
   --  Forward iteration over empty container Objectives (B) (D) (E) (J) (L).
   ...
   then
      ...
      Report.Failed
        (Descr =>
           "3) Used incorrect indexing, Constant=" &
           Natural'Image
             (Sparse_Integer_Arrays.Tc_Constant_Indexing_Use_Count) &
           ", Variable=" &
           Natural'Image
   ...
   if Sparse_Integer_Arrays.Tc_Call_History /= "I1H:F( 1)" then
      Report.Failed
        (Descr =>
           "3) Unexpected sequence of calls, " &
           Ada.Strings.Unbounded.To_String
             (Sparse_Integer_Arrays.Tc_Call_History));
   end if;
   ...
   --  Reverse iteration over an empty container. Objectives (F) (H) (I) (J)
   --  (L).
   ...
   then
      ...
      Report.Failed
        (Descr =>
           "4) Used incorrect indexing, Constant=" &
           Natural'Image
             (Sparse_Integer_Arrays.Tc_Constant_Indexing_Use_Count) &
           ", Variable=" &
           Natural'Image
   ...
   if Sparse_Integer_Arrays.Tc_Call_History /= "ILH:F( 0)" then
      Report.Failed
        (Descr =>
           "4) Unexpected sequence of calls, " &
           Ada.Strings.Unbounded.To_String
             (Sparse_Integer_Arrays.Tc_Call_History));
   end if;
   ...
   Sparse_Data.Append (Index => 1_000, New_Item => -5_000);
   Sparse_Data.Append (Index => 123, New_Item => 456_789);

   --  Forward iteration over container with multiple elements. Objectives (B)
   --  (E) (J) (L).
   for Item of Sparse_Data loop
      Item := Item + 2;
   ...
   then
      ...
      Report.Failed
        (Descr =>
           "5) Used incorrect indexing, Constant=" &
           Natural'Image
             (Sparse_Integer_Arrays.Tc_Constant_Indexing_Use_Count) &
           ", Variable=" &
           Natural'Image
   ...
   if Result /= " Value = -4998 Value =  456791" then
      Report.Failed
        (Descr =>
   ...
   then
      ...
      Report.Failed
        (Descr =>
           "6) Used incorrect indexing, Constant=" &
           Natural'Image
             (Sparse_Integer_Arrays.Tc_Constant_Indexing_Use_Count) &
           ", Variable=" &
           Natural'Image
   ...
   if Sparse_Integer_Arrays.Tc_Call_History /= "I1H:T( 1)" then
      Report.Failed
        (Descr =>
           "6) Unexpected sequence of calls, " &
           Ada.Strings.Unbounded.To_String
             (Sparse_Integer_Arrays.Tc_Call_History));
   end if;
   ...
   then
      ...
      Report.Failed
        (Descr =>
           "7) Used incorrect indexing, Constant=" &
           Natural'Image
             (Sparse_Integer_Arrays.Tc_Constant_Indexing_Use_Count) &
           ", Variable=" &
           Natural'Image
   ...
   if Result /= " Value =  456793 Value = -4995" then
      Report.Failed
        (Descr =>
   ...
   then
      ...
      Report.Failed
        (Descr =>
           "8) Used incorrect indexing, Constant=" &
           Natural'Image
             (Sparse_Integer_Arrays.Tc_Constant_Indexing_Use_Count) &
           ", Variable=" &
           Natural'Image
   ...
   if Sparse_Integer_Arrays.Tc_Call_History /= "ILH:T( 2)" then

      Report.Failed
        (Descr =>
           "8) Unexpected sequence of calls, " &
           Ada.Strings.Unbounded.To_String
             (Sparse_Integer_Arrays.Tc_Call_History));
   end if;
   ...
   then
      ...
      Report.Failed
        (Descr =>
           "9) Used incorrect indexing, Constant=" &
           Natural'Image
             (Sparse_Integer_Arrays.Tc_Constant_Indexing_Use_Count) &
           ", Variable=" &
           Natural'Image
   ...
   if Result /= " Value = -4995 Value =  456794" then
      Report.Failed
        (Descr =>
   ...
   then
      ...
      Report.Failed
        (Descr =>
           "A) Used incorrect indexing, Constant=" &
           Natural'Image
             (Sparse_Integer_Arrays.Tc_Constant_Indexing_Use_Count) &
           ", Variable=" &
           Natural'Image
   ...
   if Result /= " Value =  456794 Value = -4995" then
      Report.Failed
        (Descr =>
   ...
   --  Forward iteration over empty constant container Objectives (B) (D) (E)
   --  (J) (L).
   ...
   then
      ...
      Report.Failed
        (Descr =>
           "B) Used incorrect indexing, Constant=" &
           Natural'Image
             (Sparse_Integer_Arrays.Tc_Constant_Indexing_Use_Count) &
           ", Variable=" &
           Natural'Image
   ...
   if Sparse_Integer_Arrays.Tc_Call_History /= "I1H:F( 1)" then
      Report.Failed
        (Descr =>
           "B) Unexpected sequence of calls, " &
           Ada.Strings.Unbounded.To_String
             (Sparse_Integer_Arrays.Tc_Call_History));
   end if;
   ...
   then
      ...
      Report.Failed
        (Descr =>
           "C) Used incorrect indexing, Constant=" &
           Natural'Image
             (Sparse_Integer_Arrays.Tc_Constant_Indexing_Use_Count) &
           ", Variable=" &
           Natural'Image
   ...
   if Sparse_Integer_Arrays.Tc_Call_History /= "ILH:F( 0)" then
      Report.Failed
        (Descr =>
           "C) Unexpected sequence of calls, " &
           Ada.Strings.Unbounded.To_String
             (Sparse_Integer_Arrays.Tc_Call_History));
   end if;
