...
procedure Cxg2010 is
   ...
   package body Float_Check is
      ...
      procedure Argument_Range_Check_1 (A, B : Real; Test : String) is
         ...
         Zx, Zy                : Real;
         V                     : constant := 1.0 / 16.0;
         One_Minus_Exp_Minus_V : constant := 6.058_693_718_652_421_388E-2;
      ...
      procedure Argument_Range_Check_2 (A, B : Real; Test : String) is
         ...
         -- 1/16 - Exp(45/16)
         Coeff : constant := 2.445_332_104_692_057_038_9E-3;
      ...
      begin
         ...
         begin
            Y := Exp (0.0);
            Check (Y, 1.0, "test 4 -- exp(0.0)", 0.0);   -- no error allowed
         exception
            when Constraint_Error =>
         ...
         Argument_Range_Check_2 (1.0, Sqrt (Real (Real'Machine_Radix)), "6");
         Error_Low_Bound := 0.0;  -- reset
   ...
   package body Non_Generic_Check is
      ...
      package Elementary_Functions renames Ada.Numerics.Elementary_Functions;
      function Sqrt (X : Real) return Real renames Elementary_Functions.Sqrt;
      function Exp (X : Real) return Real renames Elementary_Functions.Exp;
...
begin
   Report.Test ("CXG2010", "Check the accuracy of the exp function");
