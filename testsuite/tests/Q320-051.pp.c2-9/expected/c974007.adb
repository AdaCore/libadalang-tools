...
begin
   ...
   Report.Test
     ("C974007",
      "ATC: trigger is protected entry call" &
   ...
   if not Perform_Transaction_Executed then
      Report.Failed
        ("Statements following asynchronous select not " & "executed");
   end if;
