...
package body C974008_0 is
   ...
   begin
      -- Simulate the situation where the user presses the cancel key before
   ...
   begin
      ...
      -- User has cancelled the transaction so we exit the loop and allow the
      -- task to terminate exit;
      -- else
      -- Key_Pressed := None;
      -- end select;
