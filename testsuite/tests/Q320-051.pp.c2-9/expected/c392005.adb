...
procedure C392005 is
   ...
   Tc_Expected_Auto_Speed : constant C392005_0.Shutter_Speed :=
     C392005_0.Two_Fifty;
   Tc_Expected_New_Aper : constant C392005_0.Aperture := C392005_0.Sixteen;
...
-- dispatching calls to Focus and Set_Shutter_Speed:
   ...
   -- For an object of type Auto_Speed, the dispatching calls should dispatch
   -- to the bodies declared for the derived type:

   C392005_0.Self_Test (Auto_Camera1);

   if C392005_0.C392005_1.Tc_Get_Depth (Auto_Camera1) /=
