...
package C950001_0 is
   ...
   procedure Unlock (L : in out Spinlock) is abstract with
   ...
   procedure Unlock_2 (L : in out Spinlock) is abstract with
      Synchronization => Optional;
   procedure Lock_2 (L : in out Spinlock) is abstract with
      Synchronization => Optional;
   ...
   procedure Try_Lock (L : in out Lock_Type; Success : out Boolean) with
      Synchronization => Optional;
