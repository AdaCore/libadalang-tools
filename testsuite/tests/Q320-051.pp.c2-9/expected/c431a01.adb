...
begin
   Report.Test
     ("C431A01",
      "In record and array aggregates: check that a " &
   ...
   declare
      ...
      O4 : F431a00.My_Rec :=
        (Info => (80, others => <>), P => <>, others => <>);
      O5 : F431a00.My_Rec :=
        (Info => (80, 'D', others => <>), P => <>, T => <>, others => <>);
   begin
      Check (O1, 4, "O1");
      Check (O2, 4, "O2");
      Check (O3, 4, "O3");
   ...
   declare
      ...
      O14 : Nested_Rec :=
        (C1 => (Info => (80, others => <>), T | P => <>), C2 => 10);
      O15 : Nested_Rec :=
        (C1 =>
           (Info => (80, C => 'D', others => <>), T | P => <>, others => <>),
         others => <>);
   begin
      Check (O11.C1, 4, "O11");
      Check (O12.C1, 4, "O12");
   ...
   declare
      ...
      procedure Check
        (Item : in out T20'Class; Value : in Integer; Message : in String)
      is
      begin
