   ...
   begin
      ...
      declare
         ...
         package C371001_0 is
            ...
            type Rec_W_Private (D1 : Integer) is record
               C : Pt_W_Disc (D1);
            end record;

            type Rec (D3 : Integer) is record
               C1 : Rec_W_Private (D3);
            end record;

         private
            type Pt_W_Disc (D : Small_Int) is record
   ...
   begin
      declare
         ...
         package C371001_1 is
            ...
            type Rec_01 (D3 : Integer) is record
               C1 : Rec_W_Private (D3);
            end record;
   ...
   begin
      declare
         ...
         package C371001_2 is
            ...
            type Rec_02 (D3 : Integer) is record
               C1 : Rec_W_Private (D3);
            end record;
      ...
      begin
         ...
         exception
            ...
            when others =>
               Report.Failed
                 ("Obj2 - unexpected exception raised in " & "assignment");
         end;
      ...
      exception
         ...
         when others =>
            Report.Failed
              ("Obj2 - unexpected exception raised in " & "declaration");
      end;
   ...
   begin
      declare
         ...
         package C371001_3 is
            ...
            type Rec_W_Private (D3, D4 : Integer) is record
               C : Pt_W_Disc (D3, D4);
            end record;

            type Rec_03 (D5 : Integer) is record
            ...
            -- raised.
         private
            type Pt_W_Disc (D1, D2 : Small_Int) is record
      ...
      begin
         declare
            Obj3 : C371001_3
              .Subtype_Rec;            -- Constraint_Error raised.
         begin
   ...
   begin
      declare
         ...
         package C371001_4 is
            ...
            type Pt_W_Disc (D : Small_Int) is private;
            type Rec_W_Private (D1, D2 : Small_Int) is record
               C : Pt_W_Disc (D2);
            end record;

            type Rec_04 (D3 : Integer) is record
      ...
      begin
         ...
         exception
            ...
            when others =>
               Report.Failed
                 ("Obj4 - unexpected exception raised in " & "assignment");
         end;
      ...
      exception
         ...
         when others =>
            Report.Failed
              ("Obj4 - unexpected exception raised in " & "declaration");
      end;
