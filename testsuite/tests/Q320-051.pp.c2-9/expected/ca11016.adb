...
-- implicitly withs parent, physical map application.
...
-- SDUGD.
   ...
   Water_Display_Subtest : begin
      ...
      -- Build color and light intensity of the basic map at latitude 3 and
      -- longitude 7.
...
-- SDUGD.
   ...
   Desert_Display_Subtest : begin
      ...
      -- Build color and light intensity of the basic map at latitude 9 and
      -- longitude 2.
...
-- SDUGD.
   ...
   Forest_Display_Subtest : begin
      ...
      -- Build color and light intensity of the basic map at latitude 8 and
      -- longitude 4.
