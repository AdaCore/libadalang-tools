...
procedure C761013 is
   ...
   begin
      if X.Finalized or X.C /= Ident_Int (15) then
         Failed ("Function result finalized too early - X1");
      end if;
      if Y /= Ident_Int (15) then
         Failed ("Function result finalized too early - Y1");
      end if;
      if Z.Component.Finalized or Z.Component.C /= Ident_Int (15) then
         Failed ("Function result finalized too early - Z1");
      end if;
   end Subtest_1;
   ...
   begin
      if X.Finalized or X.C /= Ident_Int (15) then
         Failed ("Outer object finalized way too early - X3");
      end if;
   end Subtest_3;
...
begin
   ...
   Tctouch.Validate (Expected => "i", Message => "Initial object");
   ...
   begin
      if X.Finalized or X.C /= Ident_Int (15) then
         Failed ("Function result finalized too early - X2");
      end if;
      if Y /= Ident_Int (15) then
         Failed ("Function result finalized too early - Y2");
      end if;
      if Z.Component.Finalized or Z.Component.C /= Ident_Int (15) then
         Failed ("Function result finalized too early - Z1");
      end if;
   ...
   begin
      if X.Finalized or X.C /= Ident_Int (15) then
         Failed ("Outer object finalized way too early - X4");
      end if;
   end Subtest_4;

   if Outer.Finalized or Outer.C /= Ident_Int (15) then
      Failed ("Outer object finalized too early - Outer4");
   end if;
