...
begin
   ...
   declare
      ...
      procedure My_Process (Position : in My_Doubly_Linked_Lists.Cursor) is
      begin
      ...
      procedure My_Reverse_Process
        (Position : in My_Doubly_Linked_Lists.Cursor)
      is
      begin
   ...
   My_List_2.Swap
     (I => My_List_2.Last,
      J =>
        My_Doubly_Linked_Lists.Previous
          (My_Doubly_Linked_Lists.Previous (My_List_2.Last)));
