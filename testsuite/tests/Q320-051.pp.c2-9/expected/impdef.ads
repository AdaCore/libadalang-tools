...
--=====-=====-=====-=====-=====-=====-=====-=====-=====-=====-=====-=====--
   ...
   Cxb50040_External_Name : constant String := "args_";
   --                 MODIFY HERE AS NEEDED --- ^^^^^^^^

   Cxb50041_External_Name : constant String := "tax_";
   --                 MODIFY HERE AS NEEDED --- ^^^^^^^^

   Cxb50050_External_Name : constant String := "align_";
   --                 MODIFY HERE AS NEEDED --- ^^^^^^^^

   Cxb50051_External_Name : constant String := "modify_";
   --                 MODIFY HERE AS NEEDED --- ^^^^^^^^
...
--M      new Ada.Text_IO.Integer_IO(System.Storage_Elements.Integer_Address);
   ...
   package Address_Value_Io is new Ada.Text_Io.Modular_Io
