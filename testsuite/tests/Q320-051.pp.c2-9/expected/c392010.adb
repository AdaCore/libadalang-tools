...
procedure C392010 is
   ...
   -- there is little difference between the actions for _1 and _2 in this
   -- subtest due to the nature of _2 inheriting most operations
   --
...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
   ...
   -- this subtest checks operations available to Level_1'Class, specifically
   -- those operations that are not testable in subtest_1, the operations with
   -- parameters of the two tagged type objects.
   begin
      for I in Items'Range loop

         C392010_1.Proc_W_Non
           (                               -- t_1,   t_2
           C392010_1.Func_W_Non
              (Items (I),
...
begin  -- Main test procedure.
   ...
   Tctouch.Validate
     ("CAkDBzDAkEkFkDAb" & "GAmHByHAmImJmHAd" & "GAnHBxHAnInPnHAh",
      "Subtest 1");
