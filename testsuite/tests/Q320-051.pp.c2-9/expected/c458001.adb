...
procedure C458001 is
   ...
   function Succession_Check
     (X : Integer; Result : Boolean; Forward : Boolean) return Boolean
   is
   begin
...
begin
   ...
   begin
      ...
      Expression_Value :=
        (for all I in Test_Array'Range => Succession_Check (I, True, True));
   ...
   begin
      ...
      if Last_Check < 2 then
         Failed
           ("Did not evaluate enough elements for False quantified expression - 5");
      elsif Last_Check > 2 then
         Failed
           ("Evaluated too many elements for False quantified expression - 5");
      end if;
   ...
   begin
      ...
      if Last_Check < 7 then
         Failed
           ("Did not evaluate enough elements for False quantified expression - 6");
      elsif Last_Check > 7 then
         Failed
           ("Evaluated too many elements for False quantified expression - 6");
      end if;
   ...
   begin
      ...
      --  Forward iteration to check one element exists, in this case the third
      --  element.
      Expression_Value :=
        (for some I in Test_Array'Range =>
      ...
      if Last_Check < 3 then
         Failed
           ("Did not evaluate enough elements for True quantified expression - 7");
      elsif Last_Check > 3 then
         Failed
           ("Evaluated too many elements for True quantified expression - 7");
      end if;
   ...
   begin
      ...
      --  Reverse iteration to check if one element exists, in this case the
      --  sixth element.
      Expression_Value :=
        (for some I in reverse Test_Array'Range =>
      ...
      if Last_Check < 6 then
         Failed
           ("Did not evaluate enough elements for True quantified expression - 8");
      elsif Last_Check > 6 then
         Failed
           ("Evaluated too many elements for True quantified expression - 8");
      end if;
