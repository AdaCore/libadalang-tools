...
begin
   Report.Test
     ("C540001",
      "Check that an expression in a case statement " &
   ...
   Generic_Formal_Object_Subtest : begin
      ...
      begin
         ...
         if Eobj /= Alpha then
            Report.Failed
              ("Incorrect result for value of one in generic" &
      ...
      begin
         ...
         if Eobj /= Theta then
            Report.Failed
              ("Incorrect result for value of five in generic" &
               "formal object subtest");
         end if;
      end;
      ...
      begin
         case Val_Func (P) is                         -- Case expression is
            ...
            when New_Enum_Type (C540001_1.Eh) |      -- function.
              New_Enum_Type (C540001_1.Sea)   =>
               P := 4;
            when New_Enum_Type (C540001_1.Bee) =>
               P := 7;
            when others =>
               P := 9;
         end case;
   ...
   begin
      ...
      if Snobj /= 4 then
         Report.Failed
           ("Incorrect result for value of zero in call to " &
      ...
      if Snobj /= 9 then
         Report.Failed
           ("Incorrect result for value of three in call to " &
            "generic function subtest");
      end if;

   end Instantiated_Generic_Function_Subtest;

   -- When a function call, a renaming of a function, or a call to an inherited
   ...
   begin
      ...
      if Mobj /= C540001_1.None then
         Report.Failed
           ("Incorrect result for value of true in function" & "call subtest");
      end if;
      ...
      if Mobj /= C540001_1.'A' then
         Report.Failed
           ("Incorrect result for value of false in function" &
            "call subtest");
      end if;
   ...
   begin
      ...
      if Mobj /= C540001_1.'A' then
         Report.Failed
           ("Incorrect result in call to generic formal " &
            "function subtest");
      end if;
   ...
   begin
      ...
      if Ntobj2.C1 /= C540001_1.Bee or Ntobj2.C2 /= C540001_1.'B' then
