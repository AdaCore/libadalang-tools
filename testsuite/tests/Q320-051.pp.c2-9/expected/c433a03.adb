...
begin
   Report.Test
     ("C433A03",
      "Check that for a <> in an array aggregate with " &
   ...
   begin
      ...
      begin
         F433a00.Reset_Init;
         H2 :=
           (Report.Ident_Int (8) .. Report.Ident_Int (4) =>
      ...
      begin
         F433a00.Reset_Init;
         J1 := (4 .. 2 => (F433a00.Init_Func .. F433a00.Init_Func => <>));
      ...
      begin
         F433a00.Reset_Init;
         J2 :=
           (Report.Ident_Int (4) .. Report.Ident_Int (2) =>
      ...
      begin
         F433a00.Reset_Init;
         K1 :=
           (2 .. 3 => (Report.Ident_Int (1) .. Report.Ident_Int (2) => <>));
      ...
      begin
         F433a00.Reset_Init;
         K2 :=
           (Report.Ident_Int (2) .. Report.Ident_Int (3) =>
      ...
      begin
         F433a00.Reset_Init;
         K3 :=
           (2 .. 3 => (Report.Ident_Int (2) .. Report.Ident_Int (1) => <>));
      ...
      begin
         F433a00.Reset_Init;
         L2 :=
           (Report.Ident_Int (3) .. Report.Ident_Int (4) =>
