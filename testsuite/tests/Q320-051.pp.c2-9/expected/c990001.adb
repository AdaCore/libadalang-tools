...
begin
   Report.Test
     ("C990001",
      "Check that 'Terminated and 'Callable return " &
   ...
   declare
      ...
      A2 : Boolean := Check ("T2", T2'Callable, True, T2'Terminated, False, A);
      ...
      task body Tt is
         B2 : Boolean :=
           Check ("T2", T2'Callable, True, T2'Terminated, False, B);
      begin
         Consume (B2);
         Consume (Check ("T2", T2'Callable, True, T2'Terminated, False, C));
         Main_Task.E (1);
         Main_Task.E (2);
      end Tt;
      ...
      begin
         ...
         Consume (Check ("T2", T2'Callable, False, T2'Terminated, True, D));
      end Main_Task;
   ...
   -- Check attributes for a function returning a task object (also check
   -- "current instance" using type name):
   declare
      ...
      task body Mt is
         B3 : Boolean :=
           Check ("MT", Mt'Callable, True, Mt'Terminated, False, B);
      begin
         Consume (B3);
         Consume (Check ("MT", Mt'Callable, True, Mt'Terminated, False, C));
         delay Impdef.Clear_Ready_Queue;
      end Mt;

   begin
      Consume (Check ("Func", Func'Callable, True, Func'Terminated, False, C));
      -- This will create two tasks that we have to wait for the termination of
      -- here.
   end;
   ...
   declare
      ...
      begin
         ...
         Consume (Check ("P", P'Callable, True, P'Terminated, False, C));
         Consume (Check ("F1", F1'Callable, True, F1'Terminated, False, C));
         ...
         Consume (Check ("P", P'Callable, False, P'Terminated, True, D));
         Consume (Check ("F1", F1'Callable, False, F1'Terminated, True, D));
      end Driver;
   ...
   -- Check attributes for accesses to a task object created with the access
   -- attribute:
   declare
      ...
      package Pkg2 is
         ...
         A4 : Boolean :=
           Check ("Obj2", Obj2'Callable, True, Obj2'Terminated, False, A);
      end Pkg2;
      ...
      task body Tt is
         ...
         B3 : Boolean :=
           Check ("Obj1", Obj1'Callable, True, Obj1'Terminated, False, B);
         B4 : Boolean :=
           Check ("Obj2", Obj2'Callable, True, Obj2'Terminated, False, B);
      begin
         Consume (B1);
         Consume (B2);
         Consume (B3);
         Consume (B4);
         Consume (Check ("FA", Fa'Callable, True, Fa'Terminated, False, C));
      ...
      begin
         ...
         abort Pkg1.T1;
         delay Impdef.Clear_Ready_Queue;
         Consume (Check ("FA", Fa'Callable, False, Fa'Terminated, True, D));
         Consume (Check ("FN", Fn'Callable, False, Fn'Terminated, True, D));
         Consume
           (Check ("Obj1", Obj1'Callable, False, Obj1'Terminated, True, D));
         Consume
           (Check ("Obj2", Obj2'Callable, False, Obj2'Terminated, True, D));
      end Main_Task;
