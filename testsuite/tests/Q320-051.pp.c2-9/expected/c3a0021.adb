...
begin
   ...
   begin
      declare
         O_2 : Not_Null_Int_Ptr :=
           Not_Null_Int_Ptr (Null_Init);      -- Test (type conversion).
      begin
   ...
   begin
      declare
         A_1 : Int_Ptr_Ptr :=
           new Not_Null_Int_Ptr;   -- Test (default initialization).
      begin
   ...
   begin
      declare
         type Rec (D : Not_Null_Int_Ptr) is record
            Dummy : Integer := 0;
         end record;
   ...
   begin
      declare
         type Rec (D : Not_Null_Int_Ptr := null) is record
            Dummy : Integer := 0;
         end record;
   ...
   begin
      declare
         type Rec (D : Not_Null_Int_Ptr := Non_Null_Init) is record
            Dummy : Integer := 0;
         end record;
         Ro_8 : Rec;
      begin
