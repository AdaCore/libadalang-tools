...
begin  -- Main program.
   ...
   begin
      ...
      then abort
         ...
         -- and completes before this call finishes; it is then aborted.

         -- Check that the whole of the abortable part is aborted, not just the
         -- statement in the abortable part that was executing at the time
