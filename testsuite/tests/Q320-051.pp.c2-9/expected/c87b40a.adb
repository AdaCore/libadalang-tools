...
-- INTEGER TYPE. THE SAME OPERATIONS ARE PREDEFINED FOR THE TYPE UNIVERSAL_REAL
-- AS FOR ANY FLOATING POINT TYPE. IN ADDITION THESE OPERATIONS INCLUDE THE
-- FOLLOWING MULTIPLICATION AND DIVISION OPERATORS:
--
...
-- "DIV" (UNIVERSAL_INTEGER, UNIVERSAL_INTEGER) RETURN UNIVERSAL_INTEGER "ABS"
-- (UNIVERSAL_INTEGER) RETURN UNIVERSAL INTEGER "ABS" (UNIVERSAL_REAL) RETURN
-- UNIVERSAL_REAL
