...
-- Check that the tags of allocated objects correctly identify the type of the
-- allocated object.
...
-- Check that the tags of accessed values designating aliased objects correctly
...
-- Check that the tag of a function result correctly evaluates. Check this for
