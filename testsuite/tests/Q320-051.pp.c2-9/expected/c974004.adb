...
begin  -- Main program.
   ...
   Report.Test
     ("C974004",
      ...
      "task entry and is completed first by an " & "exception");
   ...
   begin
      ...
      begin
         ...
         then abort
            ...
            -- and propagates an exception before this call finishes; it is
            -- then aborted.
         ...
         -- The propagated exception is re-raised here; control passes to the
         -- exception handler.
