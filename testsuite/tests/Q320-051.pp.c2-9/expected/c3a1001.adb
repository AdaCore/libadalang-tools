...
begin
   ...
   Report.Test
     ("C3A1001",
      "Check that the full type completing a type " &
   ...
   if (Incomplete1_Obj_1.Disc /= F) or (Incomplete1_Obj_1.Finteger /= 8) then
   ...
   if (Incomplete3_Obj_1.Disc /= 6) or (Incomplete3_Obj_1.Id /= "Sentra") then
      Report.Failed ("Wrong values for Incomplete3_Obj_1");
   end if;

   if (Incomplete1_Obj_2.Disc /= M) or (Incomplete1_Obj_2.Minteger /= 9) then
      Report.Failed ("Wrong values for Incomplete1_Obj_2");
   end if;

   if (Incomplete2_Obj_2.Disc /= 5) or (Incomplete2_Obj_2.Id /= "Buick") then
   ...
   if Incomplete1_Obj_1.Finteger /= Report.Ident_Int (1) then
   ...
   if Incomplete2_Obj_1.Id /= Return_String ("12345678") then
   ...
   if Incomplete4_Obj_1.Id /= Return_String ("87654321") then
   ...
   begin
      ...
      if Return_String (Incomplete8_Obj_1.Str) /= "Merry Xmas" then
   ...
   begin
      ...
      if Return_String (Incomplete8_Obj_2.Str) /= "Happy" then
         Report.Failed ("Wrong values for Incomplete8_Obj_1.Str");
      end if;
