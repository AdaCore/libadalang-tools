...
begin
   ...
   declare
      ...
      begin
         ...
         -- AT THIS POINT, FIVE TASKS WERE QUEUED. LET THE TIMED ENTRY CALLS
         -- ISSUED BY CALLER1, CALLER3, AND CALLER5 EXPIRE:

         delay Delay_Time + 10.0;

         -- AT THIS POINT, ALL THE TIMED ENTRY CALLS MUST HAVE EXPIRED AND BEEN
         -- REMOVED FROM THE ENTRY QUEUE FOR E, OTHERWISE THE IMPLEMENTATION
