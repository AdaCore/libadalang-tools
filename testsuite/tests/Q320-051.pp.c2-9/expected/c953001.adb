...
procedure C953001 is
   ...
   Task_Passed         : array (1 .. Max_Tasks) of Boolean :=
     (1 .. Max_Tasks => False);
...
begin
   ...
   declare -- test encapsulation
      ...
      begin
         ...
         exception
            ...
            when others =>
               Report.Failed
                 ("wrong exception raised in task" & Integer'Image (Me));
         end;
      end Waiter;
   ...
   -- all the tasks have now completed. check the flags for pass/fail info
