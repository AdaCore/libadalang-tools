...
begin -- C3A2A02.                                              -- [ Level = 1 ]
   ...
   begin -- SUBTEST1.
      ...
      begin
         ...
         -- the type of Pack_Same_Level.X'Access (F3A2A00.AccTagClass_L0) is 0.
         -- Therefore, the X'Access in Pack_Same_Level.Proc does not raise an
         -- exception when the subprogram is called. The level of execution of
         -- the subprogram is irrelevant:
      ...
      exception
         when Program_Error =>
            Result2 := F3a2a00.P_E;      -- Expected result.
         when others =>
            Result2 := F3a2a00.O_E;
      end;
   ...
   exception
      when Program_Error =>
         Report.Failed
           ("SUBTEST #1: Program_Error incorrectly raised " &
            "during instantiation of generic");
      when others =>
         Report.Failed
           ("SUBTEST #1: Unexpected exception raised " &
            "during instantiation of generic");
   end Subtest1;
   ...
   begin -- SUBTEST2.
      ...
      begin
         declare                                               -- [ Level = 4 ]
            -- The accessibility level of the actual object corresponding
            -- to FObj in Pack_PE is 3. The level of the type of FObj'Access
      ...
      exception
         when Program_Error =>
            Result1 := F3a2a00.P_E;      -- Expected result.
         when others =>
            Result1 := F3a2a00.O_E;
      end;
      ...
      begin                                                    -- [ Level = 3 ]
         declare                                               -- [ Level = 4 ]
            -- The accessibility level of the actual object corresponding
            -- to FObj in Pack_OK is 0. The level of the type of FObj'Access
   ...
   begin -- SUBTEST3.
      ...
      begin
         declare                                               -- [ Level = 4 ]
            -- Since the accessibility level of the type of X'Access in both
            -- cases within Pack_OK1 is that of the instance, and since X is
            -- either passed as an actual (in which case its level will not
            -- be deeper than that of the instance) or is declared within the
            -- instance (in which case its level is the same as that of the
            -- instance), no exception should be raised when the instance
            -- body is elaborated:
      ...
      begin
         declare                                               -- [ Level = 4 ]
            -- Since the accessibility level of the type of X'Access in both
            -- cases within Pack_OK2 is that of the instance, and since X is
            -- either passed as an actual (in which case its level will not
            -- be deeper than that of the instance) or is declared within the
            -- instance (in which case its level is the same as that of the
            -- instance), no exception should be raised when the instance
