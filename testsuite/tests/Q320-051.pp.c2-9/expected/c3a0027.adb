...
procedure C3a0027 is
   ...
   type Acc_Ptr is access protected function (X : Float) return Float;
...
begin
   Report.Test
     ("C3A0027",
      ...
      "anonynous access-to-protected-subprogram type");

   --  Object declaration tests --------------------------------------------

   begin
      declare
         O_1 : not null access protected function
   ...
   begin
      declare
         O_2 : not null access protected function (X : Float) return Float :=
   ...
   declare
      O_3 : not null access protected function (X : Float) return Float :=
        Double_Init;
   begin
   ...
   declare
      O_4 : not null access protected function (X : Float) return Float :=
        Double_Init;
   begin
   ...
   declare
      type Table is
        array
          (Integer range <>) of not null access protected function
   ...
   begin
      declare
         type Rec is record
            C : not null access protected function (X : Float) return Float;
         end record;
   ...
   begin
      declare
         type Rec
           (D : not null access protected function (X : Float) return Float)
         is record
            Dummy : Integer := 0;
         end record;
   ...
   declare
      procedure Proc_1
        (F : not null access protected function (X : Float) return Float)
      is
      begin
         Use_It (F);
      end Proc_1;
   ...
   declare
      function Evaluate
        (Fn : not null access protected function (X : Float) return Float;
   ...
   declare
      function Func_1
        (F : Acc_Ptr)
         return not null access protected function (X : Float) return Float
      is
      begin
         return F;
      end Func_1;
