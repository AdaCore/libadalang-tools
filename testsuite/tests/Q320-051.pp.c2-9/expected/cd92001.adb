...
procedure Cd92001 is
   ...
   Sparse_Component_Size : constant :=
     ...
     System.Storage_Unit;
   Default_Component_Size : constant :=
     ((Default_Enumerated'Size / System.Storage_Unit) +
      Boolean'Pos ((Sparse_Enumerated'Size mod System.Storage_Unit) /= 0)) *
     System.Storage_Unit;

   type Sparse_Enum_Table is array (Test_Width) of Sparse_Enumerated;
   for Sparse_Enum_Table'
   ...
   type Sparse_Mod_Table is array (Test_Width) of Mod_Same_Size_As_Sparse_Enum;
   for Sparse_Mod_Table'
     Component_Size use Sparse_Component_Size;  -- N/A => ERROR.

   type Default_Mod_Table is array (Test_Width) of Mod_Same_Size_As_Def_Enum;
   for Default_Mod_Table'
     Component_Size use Default_Component_Size;  -- N/A => ERROR.
   ...
   procedure Refill_Valid is
      ...
      Table : array (Mod_10) of Mod_Same_Size_As_Sparse_Enum :=
        (2, 4, 8, 16, 32, 64, 128, 256, 512, 1_024);
