...
--*
--
-- PACKAGE THAT MAY BE MODIFIED TO DECLARE FUNCTIONS THAT RETURN VALUES USABLE
-- FOR INITIALIZATION OF CONSTANTS IN PACKAGE SPPRT13.
...
-- INSERT FUNCTION DECLARATIONS AS NEEDED.
   ...
   for Mem'Alignment use Standard'Maximum_Alignment;
