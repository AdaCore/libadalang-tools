...
package C760012_0 is
   ...
   -- by 3.8(18);6.0 the following type contains components constrained by
   ...
   -- the tags are the same for SimpleA and SimpleB due to the fact that the
   -- language does not specify an ordering with respect to this component
   -- pair. 7.6(12) does specify the rest of the ordering.
