...
begin
   ...
   declare
      ...
      procedure R_Assign (R_In : in Accarr; R_Inout : in out Accarr) is
      begin
         Accarr_Var  := R_In;
         Accarr_Var0 := R_Inout;
      end R_Assign;

      procedure L_Assign (L_Out : out Accarr; L_Inout : in out Accarr) is
      begin
         L_Out   := Accarr_Const;
   ...
   begin
      ...
      if Accarr_Var0 /= Accarr_Const2 then
      ...
      if Accarr_Const /= Acc_Accarr_Var0.all then
