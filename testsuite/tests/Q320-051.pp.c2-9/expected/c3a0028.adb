...
--
--  CHANGE HISTORY:
--    02 May 2008 RLB Created ACATS test based on C3A0026.
--    18 Jul 2008 RLB Fixed return statement error.
--!
with Report;
procedure C3a0028 is

   type Acc_Func_Ptr is access function (X : Float) return Float;
...
begin
   ...
   begin
      declare
         type Rec (D : not null Acc_Func_Ptr) is record
            Dummy : Integer := 0;
         end record;
   ...
   begin
      declare
         type Rec (D : not null Acc_Func_Ptr := Null_Init) is limited record
            Dummy : Integer := 0;
         end record;
   ...
   begin
      declare
         procedure Proc_2 (F : not null Acc_Func_Ptr := Null_Init) is
         begin
            Use_It (F);
         end Proc_2;
      begin
   ...
   declare
      function Evaluate (Fn : not null Acc_Func_Ptr; X : Float) return Float is
      begin
         return Fn (X);
      end Evaluate;
   ...
   declare
      ...
      begin
         return Result : not null Acc_Func_Ptr := Double'Access do
            Result := F;
         end return;
      end Func_2;
      Obj : Acc_Func_Ptr;
