...
package C432004_1 is
   ...
   type Periods is
     (Aphebian, Helikian, Hadrynian, Cambrian, Ordovician, Silurian, Devonian,
   ...
   -- The following function is needed to verify the values of the extension's
   -- private components.
   function Tc_Correct_Result
     (Rec : Sampletype_C'Class; P : Periods) return Boolean;
   ...
   -- private components.
   function Tc_Correct_Result
     (Rec : Sampletype_H'Class; P : Periods; E : C432004_0.Eras)
      return Boolean;
