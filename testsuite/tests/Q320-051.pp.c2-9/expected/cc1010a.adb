...
--*
-- CHECK THAT THE NAMES IN A GENERIC SUBPROGRAM DECLARATION ARE STATICALLY
-- IDENTIFIED (I.E., BOUND) AT THE POINT WHERE THE GENERIC DECLARATION
-- TEXTUALLY OCCURS, AND ARE NOT DYNAMICALLY BOUND AT THE POINT OF
-- INSTANTIATION.
