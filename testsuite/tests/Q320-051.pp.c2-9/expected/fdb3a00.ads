...
--      This foundation provides the basis for testing pragma and
--      aspect Default_Storage_Pool. It provides simple implementations of
...
--      20 NOV 14   RLB    Created version for Default_Storage_Pool subclause.
--      24 NOV 14   RLB    Added TC_Id discriminant so we can report pool
--                         instance here.
--!
