...
procedure C341a04 is
   ...
   -- Define access types referring to class of types rooted at Bank.Account
   -- (root).
   ...
   -- Initialized to specific type that has been extended from the basis of the
   -- class.
   Checking_Acct : Bank_Account_Pointer :=
     new Checking.Account'(Current_Balance => 100.00, Overdraft_Fee => 10.00);

   -- Initialized to specific type that has been twice extended from the basis
   -- of the class.
   Ic_Acct : Bank_Account_Pointer :=
     new Interest_Checking.Account'
       (Current_Balance => 1_000.00, Overdraft_Fee => 10.00, Rate => 0.030);
...
begin  -- C341A04
   ...
   Report.Test
     ("C341A04",
      "Check that class-wide objects were " &
