...
begin
   ...
   Report.Test
     ("C940005",
      "Check internal calls of protected functions" & " and procedures");
   ...
   begin -- declare
      ...
      -- Now Simulate the arrival of another vehicle again causing INTERNAL
      -- CALLS but following different paths (queuing on the meter etc.)
      New_Arrival;
      delay Pulse_Time_Delta * 2;  -- allow it to pass through the complex
