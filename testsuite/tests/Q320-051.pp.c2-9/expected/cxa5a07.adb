...
begin
   ...
   begin
      ...
      begin
         ...
         Report.Failed
           ("Argument_Error not raised when the Arctan " &
      ...
      exception
         when others =>
            Report.Failed
              ("Exception raised when the Arctan function is " &
      ...
      begin
         New_Float_Result :=
           Gef.Arctan (New_Float (-Fxa5a00.Small), New_Float (-Fxa5a00.Large));
...
--pwb-math: Next line: changed 2.0*Pi to 360.0
      ...
      begin
         ...
         Report.Failed
           ("Argument_Error not raised by the Arctan function " &
...
--pwb-math: Next line: changed 2.0*Pi to 360.0
      ...
      exception
         when others =>
            Report.Failed
              ("Exception raised when the Arctan function with " &
