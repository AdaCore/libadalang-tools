...
begin
   ...
   Assert
     (The_Ground_Antenna.The_Command = Modules.Set_Data_Rate,
      "TGA disc 2");
   ...
   Assert
     (The_Space_Antenna.Electronics.Tc_S_Band_Data = 88,
      "TSA comp 2.inher.3");
