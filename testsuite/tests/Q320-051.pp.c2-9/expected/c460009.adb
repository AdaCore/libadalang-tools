...
begin
   ...
   begin
      ...
      Report.Comment
        ("Dead assignment prevention in Arr_Obj1 => " &
   ...
   begin
      ...
      Arr_Obj2 :=
        Arr_Int2'
          (Report.Ident_Int (2) .. 3 =>
             (Report.Ident_Int (2) .. Report.Ident_Int (1) =>
                Report.Ident_Int (1)));

      Report.Comment
        ("Dead assignment prevention in Arr_Obj2 => " &
   ...
   begin
      ...
      Arr_Obj3 :=
        Arr_Int3'
          (Report.Ident_Int (3) .. 2 =>
             (Report.Ident_Int (1) .. Report.Ident_Int (3) =>
                Report.Ident_Int (1)));

      Report.Comment
        ("Dead assignment prevention in Arr_Obj3 => " &
   ...
   begin
      ...
      Arr_Obj4 :=
        Arr_Int4'
          (Report.Ident_Int (1) .. 3 =>
             (Report.Ident_Int (1) .. Report.Ident_Int (2) =>
                (Report.Ident_Int (3) .. Report.Ident_Int (2) =>
                   Report.Ident_Int (1))));

      Report.Comment
        ("Dead assignment prevention in Arr_Obj4 => " &
   ...
   begin
      ...
      Report.Comment
        ("Dead assignment prevention in Arr_Obj5 => " &
   ...
   begin
      ...
      Str_Obj (Report.Ident_Int (0) .. Report.Ident_Int (-1)) :=
        (others => 'Y');
   ...
   declare
      ...
      begin
         ...
         Report.Comment
           ("Dead assignment prevention in Proc7 => " &
   ...
   declare
      ...
      begin
         ...
         Report.Comment
           ("Dead assignment prevention in Proc10 => " &
            Integer'Image (P'Last));
