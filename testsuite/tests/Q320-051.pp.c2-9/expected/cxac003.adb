      ...
      exception
         ...
         when Ada.Streams.Stream_Io.Mode_Error =>
            ...
            Try_Read : begin
               ...
               Integer'Read (Stream_Access_Value, Int_Var);
               Report.Failed ("Exception not raised by 'Read of Append file");
            exception
               when Incomplete =>
                  null;
               when Ada.Streams.Stream_Io.Mode_Error =>
      ...
      exception
         ...
         when Ada.Streams.Stream_Io.Mode_Error =>
            ...
            Eof_For_Append_File : begin
               ...
               Test_Boolean :=
                 Ada.Streams.Stream_Io.End_Of_File (Stream_File_Object);
               Report.Failed ("Exception not raised by EOF of Append file");
            exception
               when Incomplete =>
                  raise;
               when Ada.Streams.Stream_Io.Mode_Error =>
         ...
         when others =>
            Report.Failed ("Incorrect exception raised - 5a");
      end Check_End_File;
