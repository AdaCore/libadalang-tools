...
begin
   ...
   Report.Test
     ("CXF3002",
      "Check that the functionality contained " &
   ...
   Test_Block : declare
      ...
      Number_Of_Expected_Results : constant :=
        Number_Of_Decimal_Items * Number_Of_Picture_Strings;
      ...
      Decimal_Data : Decimal_Data_Array_Type (1 .. Number_Of_Decimal_Items) :=
        (1 => 5_678.90, 2 => -6_789.01, 3 => 0.00, 4 => 0.20, 5 => 3.45);
