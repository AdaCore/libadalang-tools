...
procedure Cxd1008 is
   ...
   package T1 is new Cyclic
     (Test_Cases.Do_Float,
      1.8 * Min_Period,
      Base_Priority + 0,
      1);
   package T2 is new Cyclic
     (Test_Cases.Do_Exceptions,
      1.7 * Min_Period,
      Base_Priority + 1,
      2);
   package T3 is new Cyclic
     (Test_Cases.Do_Float,
      1.6 * Min_Period,
      Base_Priority + 2,
      3);
   package T4 is new Cyclic
     (Test_Cases.Do_Exceptions,
      1.5 * Min_Period,
      Base_Priority + 3,
      4);
   package T5 is new Cyclic
     (Test_Cases.Do_Float,
      1.4 * Min_Period,
      Base_Priority + 4,
      5);
   package T6 is new Cyclic
     (Test_Cases.Do_Exceptions,
      1.3 * Min_Period,
      Base_Priority + 5,
      6);
---
   ...
   package Ticker is new Cyclic
     (Test_Cases.Preemption,
      Min_Period,
      Base_Priority + 6,
      7);
