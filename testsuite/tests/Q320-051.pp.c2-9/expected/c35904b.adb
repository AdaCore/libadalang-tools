...
--*
-- CHECK THAT INCOMPATIBLE FIXED POINT CONSTRAINTS RAISE CONSTRAINT_ERROR FOR
...
-- RJW 6/20/86
-- DWC 07/24/87 -- ADDED NUMERIC_ERROR HANDLERS. JRL 03/30/93 REMOVED
-- NUMERIC_ERROR FROM TEST. EDS 07/16/98 AVOID OPTIMIZATION
...
procedure C35904b is
   ...
   procedure Proc (Str : String) is
      ...
      -- DEFINE AN OBJECT OF SUBTYPE SFIX AND USE IT TO AVOID OPTIMIZATION OF
      -- SUBTYPE
