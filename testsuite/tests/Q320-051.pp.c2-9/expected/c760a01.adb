...
begin
   ...
   declare
      My_Ext : F760a00.Child.Lim_Ext :=
        (F760a00.Lim_Tagged with G => 10, Tc2 => <>);
   begin
   ...
   declare
      type A_Rec is record
         C : F760a00.Lim_Rec :=
           (A => Report.Ident_Int (12), B => True, Tc => <>);
         N : Natural := 0;
      end record;
      My_Rec : A_Rec;
   begin
   ...
   declare
      type A_Rec is record
         C : F760a00.Child.Lim_Ext :=
           (F760a00.Lim_Tagged with G => 20, Tc2 => <>);
         D : Character := 'A';
      end record;
      My_Rec : A_Rec;
   begin
   ...
   declare
      My_Tag : F760a00.Lim_Tagged :=
        (R => (A => Report.Ident_Int (12), B => True, Tc => <>), Tc => <>);
   begin
   ...
   declare
      ...
      Obj : Acc_Comp :=
        new F760a00.Lim_Comp'(N => Report.Ident_Int (4), others => <>);
   begin
