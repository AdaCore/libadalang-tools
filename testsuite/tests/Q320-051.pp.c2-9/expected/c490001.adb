...
begin
   Report.Test
     ("C490001",
      "Rounding of real static expressions: " & "floating point subtypes");

   -- Check that rounding direction is consistent for literals:

   Float_Subtest (12.440_193_950_021_943, P_M1, "Positive Float: literal");
   Float_Subtest (-0.692_074_550_952_117, N_M1, "Negative Float: literal");

   -- Now check that rounding is performed correctly for values between machine
   -- numbers, according to the value of 'Machine_Rounds:
