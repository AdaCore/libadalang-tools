...
begin
   Test
     ("C34014E",
      ...
      "SUBPROGRAM IS LATER DECLARED EXPLICITLY IN " & "THE PACKAGE BODY");
   ...
   declare
      ...
      begin
         if X /= 1 then
            Failed ("OLD SUBPROGRAM NOT VISIBLE - SUBPROG " & "DECL - 1");
         end if;

         if Y.C /= 2 then
            Failed ("NEW SUBPROGRAM NOT VISIBLE - SUBPROG " & "DECL");
         end if;

         if Z /= 2 then
            Failed ("OLD SUBPROGRAM NOT DERIVED - SUBPROG " & "DECL - 1");
         end if;
      end Q;
   ...
   declare
      ...
      begin
         if X /= 1 then
            Failed ("OLD SUBPROGRAM NOT VISIBLE - RENAMING - " & "1");
         end if;
         ...
         if Z /= 2 then
            Failed ("OLD SUBPROGRAM NOT DERIVED - RENAMING - " & "1");
         end if;
      end Q;
   ...
   declare
      ...
      begin
         if X /= 1 then
            Failed ("OLD SUBPROGRAM NOT VISIBLE - " & "INSTANTIATION - 1");
         end if;
         ...
         if Z /= 2 then
            Failed ("OLD SUBPROGRAM NOT DERIVED - " & "INSTANTIATION - 1");
         end if;
      end Q;
   ...
   begin
      if Y /= 1 then
         Failed ("OLD SUBPROGRAM NOT VISIBLE - INSTANTIATION - " & "2");
      end if;

      if Z /= 1 then
         Failed ("OLD SUBPROGRAM NOT DERIVED - INSTANTIATION - " & "2");
      end if;
   end;
