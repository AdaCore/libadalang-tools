...
begin  -- Main test procedure.
   ...
   Report.Test
     ("C390003",
      "Check that for a subtype S of a tagged type " &
...
-- Check the tag generated for an aggregate.
   ...
   Rentals : declare
      ...
      Diannes_Car : Vehicle.Object'Class :=
        Motivators.Tandem'(Wheels => 2, Wheel_State => (Good, Good));
      Jims_Bike : Vehicle.Object'Class :=
        Motivators.Motorcycle'(Pennys_Bike with Displacement => 350);
      Bills_Limo : Vehicle.Object'Class :=
        Motivators.Car'
          (Wheels => 4, Wheel_State => (others => Good), Displacement => 282);
      Alans_Car : Vehicle.Object'Class :=
        Motivators.Truck'(18, (others => Worn), Tare => 5_500);
...
-- Check the tag of parameters. Check that the tag is not affected by view
-- conversion.
