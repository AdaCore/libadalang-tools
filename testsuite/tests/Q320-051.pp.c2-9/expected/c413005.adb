...
procedure C413005 is
   ...
   -- This function changes the object it returns every other call; if extra
   -- calls are made to this function, the wrong object will be returned.
   begin
      Result_Count := Result_Count + 1;
      case Result_Count mod 4 is
         when 0 | 1 =>
            return Result1'Access;
         when 2 | 3 =>
            return Result2'Access;
         when others =>
            raise Program_Error;
      end case;
   end Func;
...
begin
   Report.Test
     ("C413005",
      "Check that a prefixed view is the name of a " &
