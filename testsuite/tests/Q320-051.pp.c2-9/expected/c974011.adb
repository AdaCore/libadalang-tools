...
begin  -- Main program.
   ...
   begin
      ...
      -- Now clear the entry barrier to allow the rendezvous to complete if the
      -- triggering call has not been cancelled
      Key_Po.Set (Cancel);
      --
      ...
      -- loop and terminate if the call hanging on the entry is executed.)
