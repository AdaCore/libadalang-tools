...
procedure C760002 is
   ...
   -- in the first test, test the simple cases. Also check that assignment
   -- causes a call to Adjust for a controlled object. Check that assignment
   -- of a non-controlled object does not call an Adjust procedure.
