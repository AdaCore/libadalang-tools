...
procedure C954010 is
   ...
   begin
      ...
      -- After the required computations have been performed return the message
      -- appropriately (probably to an output line driver
      null;            -- stub
   ...
   begin
      loop
         select
            accept Input do
               -- Determine to which task the message should be distributed
   ...
   begin
      loop
         ...
         or
            -- Guard until the rendezvous with the message for this task has
            -- completed
...
begin -- c954010
   ...
   -- Ensure that both messages were delivered to the computation tasks This
   -- shows that both requeues were effective.
   --
