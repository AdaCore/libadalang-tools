...
--    02 May 2008 RLB Converted to ACATS test, adding test cases.
--    17 Jul 2008 RLB Corrected multiple errors in Func_1 and Func_2.
--    07 Nov 2008 RLB Corrected spelling error in objective.
--!
with Report;
procedure C3a0026 is

   type Acc_Ptr is access function (X : Float) return Float;

   function Null_Init return Acc_Ptr is
   begin
      return null;
   end Null_Init;
   ...
   function Double_Init return Acc_Ptr is
   begin
      return Double'Access;
   end Double_Init;

   procedure Use_It (Obj : access function (X : Float) return Float) is
...
begin
   Report.Test
     ("C3A0026",
      "Check that Constraint_Error is raised when a null " &
      "access value is converted to a null excluding " &
      "anonynous access-to-subprogram type");

   --  Object declaration tests --------------------------------------------

   begin
      declare
         O_1 : not null access function
           (X : Float) return Float;    -- Test (default initialization).
      begin
   ...
   begin
      declare
         O_2 : not null access function (X : Float) return Float :=
   ...
   declare
      O_3 : not null access function (X : Float) return Float := Double_Init;
   begin
   ...
   declare
      O_4 : not null access function (X : Float) return Float := Double_Init;
   begin
   ...
   declare
      type Table is
        array
          (Integer range <>) of not null access function
   ...
   begin
      ...
      begin
         declare
            Ao_2 : Table (1 .. 2) :=
              (Double_Init, Null_Init); -- Test (aggregate)
         begin
   ...
   begin
      declare
         type Rec is record
            C : not null access function (X : Float) return Float;
         end record;
   ...
   begin
      declare
         type Rec is record
            C : not null access function (X : Float) return Float := Null_Init;
         end record;
   ...
   declare
      type Rec is record
         C : not null access function (X : Float) return Float := Double_Init;
      end record;
      Ro_5 : Rec;
   begin
   ...
   begin
      declare
         type Rec
           (D : not null access function (X : Float) return Float := Null_Init)
         is limited record
            Dummy : Integer := 0;
         end record;
   ...
   begin
      declare
         procedure Proc_2
           (F : not null access function (X : Float) return Float := Null_Init)
         is
         begin
            Use_It (F);
         end Proc_2;
   ...
   declare
      function Func_1
        (F : Acc_Ptr) return not null access function (X : Float) return Float
      is
      begin
         return F;
      end Func_1;
      Obj : access function (X : Float) return Float;
   begin
      begin
