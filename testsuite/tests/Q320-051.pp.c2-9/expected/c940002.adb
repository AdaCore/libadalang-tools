...
procedure C940002 is
   ...
   Ptr1, Ptr2, Ptr3 : Task_Pkg.Task_Ptr;
   Num              : Integer;
...
begin
   ...
   -- resource; request for resource should be granted
   ...
   -- resource; request for resource should be denied and task queued to wait
   -- for next available resource
