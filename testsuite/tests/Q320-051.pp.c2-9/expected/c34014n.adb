...
begin
   Test
     ("C34014N",
      ...
      "OPERATOR IS LATER DECLARED EXPLICITLY IN " & "THE SAME VISIBLE PART");
   ...
   declare
      ...
      begin
         if X /= 1 then
            Failed ("OLD OPERATOR NOT VISIBLE - SUBPROG " & "DECL");
         end if;
   ...
   declare
      ...
      begin
         ...
         if W /= 2 then
            Failed ("NEW OPERATOR NOT VISIBLE - " & "INSTANTIATION - 1");
         end if;

         if Z /= 2 then
            Failed ("NEW OPERATOR NOT DERIVED - " & "INSTANTIATION - 1");
         end if;
      end Q;
   ...
   begin
      if Y /= 2 then
         Failed ("NEW OPERATOR NOT VISIBLE - INSTANTIATION - " & "2");
      end if;

      if Z /= 2 then
         Failed ("NEW OPERATOR NOT DERIVED - INSTANTIATION - " & "2");
      end if;
   end;
