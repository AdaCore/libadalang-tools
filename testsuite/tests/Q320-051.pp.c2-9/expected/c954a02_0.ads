...
package C954a02_0 is  -- Printer server abstraction.
   ...
   -- Simulate a system with multiple printers. The entry Print requests that
   -- data be printed on the next available printer. The entry call is accepted
   -- when a printer is available, and completes when printing is done.
