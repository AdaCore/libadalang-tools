...
begin
   ...
   begin
      ...
      if Unb.Length (Unb.To_Unbounded_String (Length => 10)) /= 10 or
        ...
        Unb.Length
            (Unb."&"
               (Unb.To_Unbounded_String (Length => 10),
                Unb."&"
                  (Unb.To_Unbounded_String (1),
                   Unb.To_Unbounded_String (0)))) /=
          10 + 1 + 0
      then
         Report.Failed
      ...
      if not (Tc_Unb_String = Tc_String) or  -- (Unb_Str, Str)
        ...
        not
        ((Unb.Null_Unbounded_String = "") and           -- (Unb_Str, Str)
      ...
      if not
        ("Extra Space" < Unb.To_Unbounded_String ("Extra Space ") and
