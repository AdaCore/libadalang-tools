...
package body C330001_0.C330001_2 is
   ...
   begin
      ...
      Report.Comment
        ("PublicChild_Obj_03'First is" &
         Integer'Image (Publicchild_Obj_03'First));
      return False;
   ...
   begin
      ...
      -- C_E, can't change constraints of PrivateChild_Obj_04.
      ...
      Report.Comment
        ("PrivateChild_Obj_04'Last is" &
         Integer'Image (C330001_0.C330001_1.Privatechild_Obj_04'Last));
      return False;
   ...
   begin
      return
        (C330001_0.C330001_1.Privatechild_Obj_01.D = 4 and
   ...
   begin
      return
        (C330001_0.C330001_1.Privatechild_Obj_02.D = 5 and
   ...
   begin
      return
        (C330001_0.C330001_1.Privatechild_Obj_03.D = 5 and
