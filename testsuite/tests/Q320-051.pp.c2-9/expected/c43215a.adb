...
--*
-- CHECK THAT CONSTRAINT_ERROR IS RAISED FOR A POSITIONAL ARRAY AGGREGATE WHOSE
-- UPPER BOUND EXCEEDS THE UPPER BOUND OF THE INDEX SUBTYPE BUT BELONGS TO THE
-- INDEX BASE TYPE.
...
begin
   ...
   Test
     ("C43215A",
      ...
      "INDEX SUBTYPE BUT BELONGS TO THE INDEX " & "BASE TYPE");
