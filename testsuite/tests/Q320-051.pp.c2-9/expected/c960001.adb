...
begin
   ...
   declare  -- To get the Report.Result after all has completed
      ...
      -- the synchronization; Control.Stop becoming true terminates the task.
      --
      ...
      begin
         ...
         while not Control.Stop loop
            ...
            -- Calculate time for next pulse. Note: this is based on the last
            -- pulse time, not the time we returned from the delay
            --
