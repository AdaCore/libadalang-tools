...
procedure Ca11007 is
   ...
   Original_Digital_File, Converted_Digital_File : Digital.Digital_File_Type;
...
begin
   ...
   Report.Test
     ("CA11007",
      "Check that the private part of a grandchild " &
      "library unit can utilize its grandparent    " &
      "unit's private definition");

   if not Digital.Valid_Initial (Original_Analog_File) then
   ...
   Digital.Convert
     (From => Original_Analog_File,        -- Convert file to
