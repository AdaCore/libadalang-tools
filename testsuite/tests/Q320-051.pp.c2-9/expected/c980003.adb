...
procedure C980003 is
   ...
   procedure Check_State (Should_Be : States; Msg : String) is
...
begin
   ...
   Report.Test
     ("C980003",
      "Check that aborts are deferred during" &
   ...
   begin
      ...
      -- there are two implementation methods for the assignment statement:
      ...
      -- Various optimizations are allowed by 7.6 that can affect how
      -- many times Adjust and Finalize are called. Depending upon the
      -- implementation, the state can be either Finished_Adjust or
      -- Finished_Finalize. If it is any other state then the abort took
