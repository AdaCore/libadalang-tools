...
--*
-- CHECK THAT TASKING_ERROR IS RAISED IN A CALLING TASK WHEN THE TASK OWNING
-- THE ENTRY TERMINATES BEFORE RENDEZVOUS CAN OCCUR.

-- CHECK THAT RE-RAISING TASKING_ERROR, ONCE TRAPPED IN THE CALLER, DOES NOT
-- PROPAGATE OUTSIDE THE TASK BODY.

-- GOM 11/29/84
-- JWC 05/14/85
-- PWB 02/11/86 CORRECTED CALL TO TEST TO SHOW CORRECT TEST NAME. RLB 12/15/99
-- REMOVED POTENTIALLY ERRONEOUS CALLS TO REPORT.COMMENT.
