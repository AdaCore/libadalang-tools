...
--*
-- CHECK THAT WHEN A FORMAL PARAMETER OF A SUBPROGRAM, ENTRY, OR GENERIC UNIT
-- HAS AN UNCONSTRAINED TYPE WITH DISCRIMINANTS THAT DO NOT HAVE DEFAULTS,
-- 'CONSTRAINED IS 'TRUE' REGARDLESS OF THE MODE OF THE PARAMETER.
