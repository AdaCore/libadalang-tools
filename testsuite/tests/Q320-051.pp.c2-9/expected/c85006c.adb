      ...
      begin
         ...
         do
            declare
               ...
               task type Task2 is
                  entry Entry1
                    (Tri1 : out Integer; Tra1 : out Array1; Trr1 : out Record1;
                     ...
                     Trt1 : in out Task1; Tai1 : out Arr_Int;
                     Taa1 :    out Arr_Arr; Tar1 : out Arr_Rec;
                     Tap1 : in out Arr_Ptr; Tav1 : in out Arr_Pvt;
                     Tat1 : in out Arr_Tsk);
               end Task2;
               ...
               begin
                  ...
                  do
                     ...
                     Tar1 :=
                       (others =>
                          (D => 1, Field1 => (Ar1 (Tar1'First).Field1 + 1)));
                     Tap1 :=
                       (others => new Integer'(Tap1 (Tap1'First).all + 1));
               ...
               procedure Proc1
                 (Pri1 : in out Integer; Pra1 : in out Array1;
               ...
               begin
                  ...
                  Par1 :=
                    (others =>
                       (D => 1, Field1 => (Par1 (Par1'First).Field1 + 1)));
            ...
            begin
               ...
               Xar1 :=
                 (others =>
                    (D => 1, Field1 => (Xar1 (Xar1'First).Field1 + 1)));
               ...
               Aa1 (Xaa1'Range) :=
                 (others => (others => Aa1 (Xaa1'First) (1) + 1));
               Ar1 (Xar1'Range) :=
                 (others => (D => 1, Field1 => (Ar1 (Xar1'First).Field1 + 1)));
               Ap1 (Xap1'Range) :=
