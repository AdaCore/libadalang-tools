...
begin
   ...
   Report.Test
     ("CB41002",
      "Check that the message string input parameter " &
   ...
   Test_Block : declare
      ...
      User_Messages : constant array
        (1 .. Number_Of_Exceptions) of String_Ptr :=
        (new String'("Msg"),
         new String'
      ...
      procedure Check_Exception_Information
        (Occur : in Ada.Exceptions.Exception_Occurrence)
      is
         ...
         begin
            for I in
              Report.Ident_Int (Target'First) ..
                Target'Last - Search'Length + 1
            loop
