...
package C760009_3 is
   ...
   -- make 1 call to C760009_2.Adjust make 2 call to C760009_1.Adjust

   -- Finalize operation will
   -- make 1 call to C760009_2.Finalize make 2 call to C760009_1.Finalize

   procedure Validate (Ac : in out Master_Control);

   package Check_1 is new C760009_0 (Master_Control, Validate);
