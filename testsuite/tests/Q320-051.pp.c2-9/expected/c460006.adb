...
begin
   Report.Test
     ("C460006",
      "Check that a view conversion to a tagged type " &
   ...
   begin
      ...
      if Cw_Var /=
        Parent_Type'Class (Grandchild_Type'(None, None, 15, "Hello", "Weird"))
      then
   ...
   begin
      ...
      if Ren3 /=
        Parent_Type'Class
          (Grandchild_Type'
             (Grandchild_Outer, Grandchild_Inner, 15, "Hello", "World"))
      then
   ...
   begin
      ...
      if Classwide /=
        Parent_Type'Class
          (Grandchild_Type'
             (Grandchild_Outer, Grandchild_Inner, 44, "Hello", "World"))
      then
