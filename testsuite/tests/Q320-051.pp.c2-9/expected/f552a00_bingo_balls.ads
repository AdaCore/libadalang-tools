...
package F552a00_Bingo_Balls is
   ...
   type Bingo_Call is
     (B_1, I_16, N_31, G_46, O_61, B_2, I_17, N_32, G_47, O_62, B_3, I_18,
      N_33, G_48, O_63, B_4, I_19, N_34, G_49, O_64, B_5, I_20, N_35, G_50,
      O_65, B_6, I_21, N_36, G_51, O_66, B_7, I_22, N_37, G_52, O_67, B_8,
      I_23, N_38, G_53, O_68, B_9, I_24, N_39, G_54, O_69, B_10, I_25, N_40,
      G_55, O_70, B_11, I_26, N_41, G_56, O_71, B_12, I_27, N_42, G_57, O_72,
      B_13, I_28, N_43, G_58, O_73, B_14, I_29, N_44, G_59, O_74, B_15, I_30,
      N_45, G_60, O_75);

   type Bingo_Game is tagged private with
   ...
   package Bingo_Iterator is new Ada.Iterator_Interfaces (Cursor, Has_Element);

   function Iterate
     (Container : Bingo_Game) return Bingo_Iterator.Forward_Iterator'Class;

   type Constant_Reference_Type (Element : not null access constant Bingo_Call)
   is
     private with
...
private
   ...
   type Bingo_Ball_Array is
     array (1 .. Bingo_Index'Last) of aliased Bingo_Call;
