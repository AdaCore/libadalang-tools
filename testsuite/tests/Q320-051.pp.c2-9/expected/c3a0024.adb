...
begin
   ...
   begin
      declare
         A_1 : Rec_Ptr_Ptr :=
           new Not_Null_Rec_Ptr;   -- Test (default initialization).
      begin
   ...
   begin
      declare
         type Rec (D : Not_Null_Rec_Ptr) is record
            Dummy : Integer := 0;
         end record;
   ...
   begin
      declare
         type Rec (D : Not_Null_Rec_Ptr := null) is record
            Dummy : Integer := 0;
         end record;
   ...
   begin
      declare
         type Rec (D : Not_Null_Rec_Ptr := Non_Null_Init) is record
            Dummy : Integer := 0;
         end record;
         Ro_8 : Rec;
      begin
