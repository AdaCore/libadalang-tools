...
--*
-- CHECK THAT CONSTRAINT_ERROR IS NOT RAISED WHEN AN ENTRY IS DECLARED IF THE
-- VALUE OF THE DEFAULT EXPRESSION FOR THE FORMAL PARAMETER DOES NOT SATISFY
-- THE CONSTRAINTS OF THE TYPE MARK, BUT IS RAISED WHEN THE ENTRY IS CALLED
...
begin
   ...
   begin
      ...
      declare
         ...
         type A1 is array (1 .. Ident_Int (1), 1 .. Ident_Int (10)) of Integer;
