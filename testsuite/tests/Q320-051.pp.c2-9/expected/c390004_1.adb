...
package body C390004_1 is
   ...
   begin
      if To_Equip /= T_Veh then
         Report.Failed
           ("Failed, called Vehicle for " & Equipment'Image (To_Equip));
      end if;
   end Tc_Check;
   ...
   begin
      if To_Equip /= T_Car then
         Report.Failed
           ("Failed, called Car for " & Equipment'Image (To_Equip));
      end if;
   end Tc_Check;
   ...
   begin
      if To_Equip /= T_Con then
         Report.Failed
           ("Failed, called Convertible for " & Equipment'Image (To_Equip));
      end if;
   end Tc_Check;
   ...
   begin
      if To_Equip /= T_Jep then
         Report.Failed
           ("Failed, called Jeep for " & Equipment'Image (To_Equip));
      end if;
   end Tc_Check;
