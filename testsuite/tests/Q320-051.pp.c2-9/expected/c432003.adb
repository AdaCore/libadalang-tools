...
begin
   ...
   Report.Test
     ("C432003",
      "Extension aggregates where ancestor part " &
   ...
   begin
      ...
      -- The following cases test where a new discriminant corresponds to
      -- multiple discriminants of the type of the ancestor part.

      begin
         declare
            S : C432003_0.Mult_Nt_A1 :=                              -- OK
              (C432003_0.Mult_Unconstr_Der with D3 => 15, S3 => String15);
         begin
