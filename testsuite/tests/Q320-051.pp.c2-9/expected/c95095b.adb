...
--*
-- CHECK THAT OVERLOADED ENTRY DECLARATIONS ARE PERMITTED IN WHICH THERE IS A
-- MINIMAL DIFFERENCE BETWEEN THE DECLARATIONS.
...
begin
   ...
   -- ONE ENTRY HAS ONE MORE PARAMETER THAN THE OTHER. THIS IS TESTED IN THE
   -- CASE IN WHICH THAT PARAMETER HAS A DEFAULT VALUE, AND THE CASE IN WHICH
   -- IT DOES NOT.
   ...
   begin
      ...
      S := "12";
      T.E2 (B, I);
      -- NOTE THAT A CALL TO T.E2 WITH ONLY ONE PARAMETER IS AMBIGUOUS.
