...
--*
-- CHECK THAT NO EXCEPTION IS RAISED FOR A NULL ARRAY WHOSE DIFFERENCE IN
-- BOUNDS LIES OUTSIDE THE INDEX BASE TYPE.
...
begin
   Test
     ("C36172C",
      "CHECK THAT NO EXCEPTION IS RAISED FOR A NULL " &
