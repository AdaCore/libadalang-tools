...
begin
   ...
   Report.Test
     ("C324001",
      "Check predicate checks are performed for static and dynamic " &
      "subtype predicates");
   begin
      Even_Var_1 := 1;
   ...
   begin
      ...
      begin
         Report.Failed
           ("Predicate should fail on initialization of Even_Var_3");
      end;
   exception
      when Assertion_Error =>
         null; -- OK
   ...
   begin
      ...
      begin
         Report.Failed
           ("Predicate specified for Defaults_P should fail - " &
   ...
   begin
      ...
      begin
         Report.Failed
           ("Predicate specified for No_Defaults_P should fail - " &
            "explicit initialization");
      end;
   exception
      when Assertion_Error =>
   ...
   exception
      when Constraint_Error =>
         Report.Failed
           ("Constraint_Error raised by unnecessary predicate " &
            "evaluation - P2");
   end;
   ...
   begin
      ...
      Report.Failed ("Predicate is false - access out parameter " & "- P3");
   exception
      when Constraint_Error =>
         Report.Failed
           ("Constraint_Error raised by unnecessary predicate " &
   ...
   begin
      ...
      Report.Failed
        ("Constraint_Error not raised during evaluation of " &
         "predicate - P5");
   exception
      when Constraint_Error =>
         null; -- OK
   ...
   begin
      ...
      Report.Failed ("Predicate is false - access out parameter " & "- P6");
   exception
      when Assertion_Error =>
         null; -- OK
   end;
