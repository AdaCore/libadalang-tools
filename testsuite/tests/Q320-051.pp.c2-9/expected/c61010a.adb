...
procedure C61010a is
   ...
   package Pkg is
      ...
      procedure Look_Inout_Vr
        (X : in out Vrtype; C : Integer; I : Integer; S : String; M : String);
   ...
   procedure Check_Inout_Vr
     (X : in out Vrtype; Oc : Integer; Oi : Integer; Os : String; Nc : Integer;
      Ni :        Integer; Ns : String; M : String)
   is
   begin
   ...
   procedure Check_Inout_R
     (X  : in out Rtype; Oj : Integer; Oc : Integer; Oi : Integer; Os : String;
      Nj :        Integer; Nc : Integer; Ni : Integer; Ns : String; M : String)
   is
   begin
