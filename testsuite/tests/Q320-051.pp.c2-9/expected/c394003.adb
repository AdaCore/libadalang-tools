...
begin
   ...
   if R /= 50 then
      Report.Failed ("Subtest 27 failed: " & Integer'Image (R));
   end if;
   ...
   if R /= 51 then
      Report.Failed ("Subtest 28 failed" & Integer'Image (R));
   end if;
   ...
   if R /= 50 then
      Report.Failed ("Subtest 29 failed: " & Integer'Image (R));
   end if;
   ...
   if R /= 51 then
      Report.Failed ("Subtest 30 failed" & Integer'Image (R));
   end if;
   ...
   if R /= 52 then
      Report.Failed ("Subtest 31 failed: " & Integer'Image (R));
   end if;
   ...
   if R /= 50 then
      Report.Failed ("Subtest 32 failed: " & Integer'Image (R));
   end if;
   ...
   if R /= 51 then
      Report.Failed ("Subtest 33 failed" & Integer'Image (R));
   end if;
   ...
   if R /= 52 then
      Report.Failed ("Subtest 34 failed: " & Integer'Image (R));
   end if;
   ...
   if R /= 50 then
      Report.Failed ("Subtest 35 failed: " & Integer'Image (R));
   end if;
   ...
   if R /= 51 then
      Report.Failed ("Subtest 36 failed" & Integer'Image (R));
   end if;
   ...
   if R /= 53 then
      Report.Failed ("Subtest 37 failed: " & Integer'Image (R));
   end if;
   ...
   if R /= 50 then
      Report.Failed ("Subtest 38 failed: " & Integer'Image (R));
   end if;
   ...
   if R /= 51 then
      Report.Failed ("Subtest 39 failed" & Integer'Image (R));
   end if;
   ...
   if R /= 52 then
      Report.Failed ("Subtest 40 failed: " & Integer'Image (R));
   end if;
   ...
   if R /= 50 then
      Report.Failed ("Subtest 41 failed: " & Integer'Image (R));
   end if;
   ...
   if R /= 51 then
      Report.Failed ("Subtest 42 failed" & Integer'Image (R));
   end if;
   ...
   if R /= 53 then
      Report.Failed ("Subtest 43 failed: " & Integer'Image (R));
   end if;
   ...
   if R /= 50 then
      Report.Failed ("Subtest 44 failed: " & Integer'Image (R));
   end if;
   ...
   if R /= 51 then
      Report.Failed ("Subtest 45 failed" & Integer'Image (R));
   end if;
   ...
   if R /= 52 then
      Report.Failed ("Subtest 46 failed: " & Integer'Image (R));
   end if;
