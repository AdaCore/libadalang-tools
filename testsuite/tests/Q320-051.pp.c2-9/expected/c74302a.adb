...
-- CHECK THAT MULTIPLE DECLARATIONS MAY BE USED FOR THE FULL DECLARATIONS, EVEN
-- IF THE DEFERRED CONSTANT DECLARATIONS ARE GIVEN INDIVIDUALLY.
...
begin
   ...
   Test
     ("C74302A",
      "CHECK THAT MULTIPLE DECLARATIONS MAY BE USED " &
