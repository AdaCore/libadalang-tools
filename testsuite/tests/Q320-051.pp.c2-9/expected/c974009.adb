...
begin  -- Main program.
   ...
   begin
      ...
      begin
         ...
         -- Ensure task is waiting a the accept so the call is not queued This
         -- is the time required to activate another task and allow it to run
         -- to its first accept statement
         --
         ...
         then abort
            ...
            -- and propagates an exception before this call is executed
         end select;
