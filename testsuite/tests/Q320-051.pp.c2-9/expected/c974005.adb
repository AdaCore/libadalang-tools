...
begin  -- Main program.
   ...
   Report.Test
     ("C974005",
      "ATC: trigger is queued but task terminates" &
   ...
   begin
      ...
      begin
         ...
         select
            ...
            -- Tasking_Error raised here when Keyboard completes before entry
            -- call can be accepted, and before abortable part completes.
         ...
         then abort
            ...
            -- accepted, and before this call finishes. Tasking_Error is raised
            -- at the point of the entry call, and this call is aborted.
            -- Check that the whole of the abortable part is aborted, not just
            -- the statement in the abortable part that was executing at the
            -- time
