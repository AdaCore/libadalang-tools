...
begin
   ...
   Report.Test
     ("C940010",
      "Check that an exception raised in an entry " &
   ...
   declare  -- encapsulate the test
      ...
      protected body Ramp_31 is
         ...
         procedure Subtract_Meter_Queue is
            ...
            Tc_Pass_Point9 : constant Integer := 1_000;  -- error
         begin
            ...
            case Tc_Current_Exception is
               ...
               when 3 =>
                  ...
                  -- RUN TIME EXCEPTION (Constraint_Error) Add the value 3 to
                  -- 5 then try to assign it to an object whose range is 0..3
                  -- - this causes the exception. Disguise the values which
                  -- cause the Constraint_Error so that the optimizer will
                  -- not eliminate this code
                  ...
                  --    the end of the test.
                  -- Otherwise the optimizer could decide that the result of
                  -- the assignment was not used so why bother to do it?
