...
-- RAISED IF T IS A SCALAR SUBTYPE AND X IS OUTSIDE THE RANGE OF T, OR IS
-- WITHIN T'S RANGE AND OUTSIDE OF THE RANGE OF VALUES PERMITTED FOR OBJECTS
-- DESIGNATED BY VALUES OF THE ALLOCATOR'S BASE TYPE.
