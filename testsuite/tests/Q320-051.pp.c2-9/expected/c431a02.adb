...
begin
   Report.Test
     ("C431A02",
      "Check that for each association with a <> in " &
   ...
   begin
      ...
      if O1.C.Info = 33 then
         Report.Failed
           ("Used default initialization for O1 rather than " &
            "default expreesion");
   ...
   begin
      ...
      if O2.C.Info = 33 then
         Report.Failed
           ("Used default initialization for O2 rather than " &
            "default expreesion");
   ...
   begin
      ...
      if O12.A (1).Info = 33 then
         Report.Failed
           ("Used default initialization rather than " &
