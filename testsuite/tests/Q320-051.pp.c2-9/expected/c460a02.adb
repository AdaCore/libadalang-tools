...
begin -- C460A02.                                              -- [ Level = 1 ]
   ...
   begin -- SUBTEST1.
      ...
      begin                                                    -- [ Level = 3 ]
         declare                                               -- [ Level = 4 ]
            -- The accessibility level of the actual passed as the target
            -- type in Pack_OK is 2. The accessibility level of the composite
            -- actual (and thus, the level of the anonymous type of the access
   ...
   begin -- SUBTEST2.
      ...
      begin
         declare                                               -- [ Level = 4 ]
            -- The accessibility level of the actual passed as the target
            -- type in Pack_PE is 2. The accessibility level of the composite
            -- actual (and thus, the level of the anonymous type of the access
            -- discriminant, which is the same as that of the containing
            -- object) is 3. Therefore, the access type conversion in
            -- Pack_PE propagates Program_Error upon instantiation:
   ...
   begin -- SUBTEST3.
      ...
      declare                                                  -- [ Level = 3 ]
         ...
         -- in Pack_OK is 3. The accessibility level of the operand type
         -- is that of the instance, which is also 3. Therefore, the access
         -- type conversion in Pack_OK does not raise an exception upon
         -- instantiation. If an exception is (incorrectly) raised, it
   ...
   begin -- SUBTEST4.
      ...
      declare                                                  -- [ Level = 3 ]
         ...
         -- The accessibility level of the actual passed as the target type in
         -- Pack_PE is 0. The accessibility level of the operand type is that
         -- of the instance, which is 3. Therefore, the access type conversion
         -- in Pack_PE raises Program_Error upon instantiation. The exception
         -- is handled within the instance:
   ...
   begin -- SUBTEST5.
      ...
      begin
         ...
         -- accessibility level of the actual passed as the target type is also
         -- 0. Therefore, the access type conversion in Proc does not raise
         -- an exception when the subprogram is called. If an exception is
         -- (incorrectly) raised, it is handled within the subprogram:
   ...
   begin -- SUBTEST6.
      ...
      begin
         ...
         -- parameter is an allocator. Its accessibility level is that of the
         -- level of execution of Proc, which is 3. The accessibility level of
         -- the actual passed as the target type is 0. Therefore, the access
         -- type conversion in Proc raises Program_Error when the subprogram
         -- is called. The exception is handled within the subprogram:
