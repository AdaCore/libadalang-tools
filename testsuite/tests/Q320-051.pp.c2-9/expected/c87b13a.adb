...
--
-- THE LOWER AND UPPER BOUNDS OF AN INDEX CONSTRAINT IN A CONSTRAINED ARRAY
-- TYPE DEFINITION MUST BE DISCRETE AND OF THE SAME TYPE.
...
procedure C87b13a is
   ...
   begin
      Failed
        ("INDEX CONSTRAINT BOUNDS MUST BE DISCRETE AND " &
         " OF THE SAME TYPE");
      return 0.0;
   end F1;
...
begin
   Test
     ("C87B13A",
      "OVERLOADED INDEX CONSTRAINTS IN " &
