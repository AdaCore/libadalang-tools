...
begin
   ...
   declare
      task Main_Task is
         entry Start
           (Ti1 : in out Integer; Ta1 : in out Array1; Tr1 : in out Record1;
      ...
      begin
         ...
         do
            declare
               ...
               task type Task2 is
                  entry Entry1
                    (Tti1 : out Integer; Tta1 : out Array1; Ttr1 : out Record1;
                     Ttp1 : in out Pointer1; Ttv1 : in out Pack1.Privy;
                     Ttt1 : in out Task1);
               end Task2;
               ...
               procedure Proc1
                 (Pti1 : in out Integer; Pta1 : in out Array1;
