...
begin
   ...
   begin
      ...
      -- Use the wide characters of Source_String1 ("abcde") and pad the last
      -- five wide characters of Result_String with 'x' wide characters.
      ...
      -- Use the wide characters of Source_String1 ("abcde") and pad the first
      -- five wide characters of Result_String with 'x' wide characters.
