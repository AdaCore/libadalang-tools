...
--*
-- CHECK THAT THE ATTRIBUTES 'IMAGE' AND 'VALUE' YIELD THE CORRECT RESULTS
-- WHEN THE PREFIX IS A FORMAL DISCRETE TYPE WHOSE ACTUAL PARAMETER IS AN
-- ENUMERATION TYPE OTHER THAN A BOOLEAN OR A CHARACTER TYPE. SUBTESTS ARE:
