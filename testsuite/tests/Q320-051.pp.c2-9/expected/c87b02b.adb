...
--
-- IN A VARIABLE DECLARATION, THE TYPE OF THE INITIALIZATION EXPRESSION MUST
-- MATCH THE VARIABLE'S EXPLICIT TYPEMARK.
--
...
begin
   Test
     ("C87B02B",
      "OVERLOADED INITIALIZATION EXPRESSIONS" & " IN VARIABLE DECLARATIONS");
   declare

      function "REM" (X, Y : Integer) return Integer renames F1;

      function "REM" (X, Y : Whole) return Whole renames F1;

      function "REM" (X, Y : Integer) return Hue renames F1;

      function "REM" (X, Y : Integer) return Citrus renames F1;
