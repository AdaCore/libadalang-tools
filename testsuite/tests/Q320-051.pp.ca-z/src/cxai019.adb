...
begin
   ...
   begin
      ...
      -- Normal call:
      Test (Value    =>
               My_Doubly_Linked_Lists.Constant_Reference(My_List_1,
      ...
      Test_and_Mod (
            Value    =>
               My_Doubly_Linked_Lists.Reference(My_List_1,
                   Position => My_Cursor_1).Element.all,
            Expected => Value_In_Array (1),
   ...
   begin
      ...
      for I in Array_Bounds_Type loop
         ...
         if My_Doubly_Linked_Lists.Element (Position => My_Cursor_1) /= 0.0 then
