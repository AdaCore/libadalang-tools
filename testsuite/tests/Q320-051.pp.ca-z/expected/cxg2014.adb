...
procedure Cxg2014 is
   ...
   package body Generic_Check is
      package Elementary_Functions is new Ada.Numerics
        ...
        (Real);
      function Sinh (X : Real) return Real renames Elementary_Functions.Sinh;
      function Cosh (X : Real) return Real renames Elementary_Functions.Cosh;
      ...
      exception
         ...
         when others =>
            Report.Failed
              ("exception in Identity_1_Test" & " for X=" & Real'Image (X));
      end Identity_1_Test;
