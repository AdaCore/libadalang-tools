...
begin
   ...
   begin
      ...
      Report.Test
        ("CB20007",
         "Check that exceptions are raised and can " &
      ...
      if not
        (Semaphore.Handled_In_Procedure_Caller and -- Incorrect exception
   ...
   exception
      ...
      when others =>
         Report.Failed
           ("Unexpected exception " & " raised and propagated in test");
   end Test_Block;
