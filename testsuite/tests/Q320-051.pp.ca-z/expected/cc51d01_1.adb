...
-- The implementation of CC51D01_1 is purely artificial; the validity of
...
-- implementation, which updates the object's SSN field. Write_Element
-- then adds the object to the list.
