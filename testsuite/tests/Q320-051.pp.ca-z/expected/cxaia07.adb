...
begin
      ...
      J =>
        My_Indefinite_Multiway_Trees.Previous_Sibling
          (Position =>
             My_Indefinite_Multiway_Trees.Previous_Sibling
               (Position =>
                  My_Indefinite_Multiway_Trees.Last_Child
                    (Parent => Root_2))));
   ...
   -- (4).all, Value_In_Ptr_Array (5).all, Value_In_Ptr_Array
   -- (6).all, Value_In_Ptr_Array (7).all, Value_In_Ptr_Array
   -- (8).all, Value_In_Ptr_Array (9).all, Value_In_Ptr_Array (10).all
   ...
   Second_Child_Cursor_1 :=
     My_Indefinite_Multiway_Trees.Next_Sibling
       (Position => First_Child_Cursor_1);
   ...
   Greatgrandchild_Cursor_1 :=
     My_Indefinite_Multiway_Trees.Find_In_Subtree
       (Position => First_Grandchild_Cursor_1,
        Item     => Value_In_Ptr_Array (9).all);

   if Greatgrandchild_Cursor_1 /=
     My_Indefinite_Multiway_Trees.First_Child
       (Parent => First_Grandchild_Cursor_1)
   then
   ...
   begin
      ...
      My_Indefinite_Multiway_Trees.Iterate_Children
        (Parent => My_Indefinite_Multiway_Trees.First_Child (Parent => Root_1),
         Process => My_Process'Access);
   ...
   Last_Child_Cursor_1 :=
     My_Indefinite_Multiway_Trees.Last_Child (Parent => Root_1);
