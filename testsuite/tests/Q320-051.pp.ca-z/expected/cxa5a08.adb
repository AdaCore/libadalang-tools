...
begin
   ...
   begin
      ...
      begin
         ...
         Report.Failed
           ("Argument_Error not raised when the Arccot " &
      ...
      exception
         when others =>
            Report.Failed
              ("Exception raised when the Arccot function is " &
      ...
      begin
         New_Float_Result :=
           Gef.Arccot (New_Float (-Fxa5a00.Small), New_Float (-Fxa5a00.Large));
      ...
      begin
         ...
         Report.Failed
           ("Argument_Error not raised by the Arccot function " &
...
--pwb-math  Next line: changed 2.0*Pi to 360.0
      ...
      exception
         when others =>
            Report.Failed
              ("Exception raised when the Arccot function with " &
