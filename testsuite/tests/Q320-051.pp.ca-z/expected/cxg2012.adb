...
procedure Cxg2012 is
   ...
   package body Generic_Check is
      ...
      begin
         for I in Ic'Range loop
            ...
            exception
               ...
               when others =>
                  Report.Failed
                    ("exception in rtoi test " & Integer'Image (I));
            end;
         end loop;
      ...
      exception
         when Constraint_Error =>
            Report.Failed ("Constraint_Error raised in Small Range Test");
         when others =>
...
begin
   Report.Test ("CXG2012", "Check the accuracy of the ** operator");
