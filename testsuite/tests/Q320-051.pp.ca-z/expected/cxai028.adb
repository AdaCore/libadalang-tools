...
--      Ada.Containers.Bounded_Ordered_Maps. Each of the subprograms is
...
begin
   ...
   My_Map_1.Insert (Key => My_Key_Type (1), New_Item => Value_In_Array (1));

   declare

      My_Constant_Reference : My_Bounded_Ordered_Maps
        .Constant_Reference_Type :=
        My_Map_1.Constant_Reference (Key => My_Key_Type (1));
   ...
   declare
      ...
      My_Reference : My_Bounded_Ordered_Maps.Reference_Type :=
        My_Map_1.Reference (Key => My_Key_Type (1));

   begin

      Tampering_Check (Container => My_Map_1, Where => "Reference (key form)");
   ...
   declare
      ...
      My_Constant_Reference : My_Bounded_Ordered_Maps
        .Constant_Reference_Type :=
        My_Map_1.Constant_Reference (Position => My_Map_1.First);
   ...
   begin
      ...
      Test
        (Value =>
           My_Bounded_Ordered_Maps.Constant_Reference
      ...
      Test_And_Mod
        (Value =>
           My_Bounded_Ordered_Maps.Reference (My_Map_1, Key => My_Key_Type (1))
             .Element.all,
      ...
      Test_And_Mod
        (Value =>
           My_Bounded_Ordered_Maps.Reference
             (My_Map_1, Position => My_Cursor_1)
             .Element.all,
      ...
      Test
        (Value     => My_Map_1.Constant_Reference (Position => My_Cursor_1),
      ...
      Test
        (Value     => My_Map_1 (My_Key_Type (1)), -- Constant_Indexing
   ...
   begin
      ...
      for E of My_Map_1 loop
         ...
         Tampering_Check (Container => My_Map_1, Where => "writing of loop");
      ...
      for I in Array_Bounds_Type loop
         ...
         if My_Bounded_Ordered_Maps.Element (Position => My_Cursor_1) /= 0.0
         then
