...
begin
         ...
         begin
            case To is
               when A =>
                  ...
                  Dir_Io.Reset (File, Dir_Io.File_Mode'Value ("Append_File"));
               when I =>
                  begin
                     Dir_Io.Reset (File, Dir_Io.File_Mode'Value ("In_File"));
                  exception
               ...
               when O =>
                  begin
                     Dir_Io.Reset (File, Dir_Io.File_Mode'Value ("Out_File"));
                  exception
                     when Dir_Io.Use_Error =>
                        Report.Not_Applicable
      ...
      exception
         ...
         when Constraint_Error =>
            ...
            if Tc_Append_Test_Executed then
               Report.Comment
                 ("Constraint_Error correctly raised on " &
   ...
   exception
      ...
      when others =>
         Report.Failed ("Unexpected exception raised on Direct IO Create");
