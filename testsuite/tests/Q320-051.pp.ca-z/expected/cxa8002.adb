...
begin
   ...
   begin
      ...
      Data_Io.Create
        (File => Employee_Data_File,    -- Create file in
   ...
   declare
      ...
      begin
         case Report.Ident_Int (Selector) is
            when 1 =>
               return Data_Io.In_File;
            when 2 =>
               return Data_Io.Out_File;
            when others =>
               return Data_Io.Append_File;
         end case;
   ...
   begin
      ...
      if Data_Io.Is_Open (Employee_Data_File) then -- File remains open
         ...
         Report.Failed ("File status not Open following Reset to Append mode");
      end if;
      ...
      begin
         ...
         if not
           ((Tc_Employee_Data (1 .. 3) = "123")
            and then (Tc_Employee_Data (4 .. 11) = "-45-6789"))
         then
         ...
         if
           ((Tc_Employee_Data (1 .. 6) /= "987-65")
            or else not (Tc_Employee_Data (3 .. 11) = "7-65-4321"))
         then
   ...
   begin
      ...
      if Data_Io.Is_Open (Employee_Data_File) then
         ...
         Data_Io.Open (Employee_Data_File, Data_Io.In_File, Employee_Filename);
         Data_Io.Delete (Employee_Data_File);
      end if;
   exception
      when others =>
