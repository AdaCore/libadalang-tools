...
begin
   ...
   begin
      ...
      if Tc_Result_Unsigned_16 /= Unsigned_16'Last - (2**0 + 2**1 + 2**2) then
      ...
      Tc_Val_Unsigned_16    := Unsigned_16'Last;  -- 65535.
      Tc_Result_Unsigned_16 :=
        Rotate_Left (Value => Tc_Val_Unsigned_16, Amount => Tc_Amount);
      ...
      Tc_Result_Unsigned_16 :=
        Rotate_Right (Value => Tc_Val_Unsigned_16, Amount => Tc_Amount);
