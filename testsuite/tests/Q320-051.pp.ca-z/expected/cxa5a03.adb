...
begin
   ...
   begin
      ...
      exception
         when others =>
            Report.Failed
              ("Unexpected exception on GEF.Tan with large " &
               "positive value");
      end;
      ...
      exception
         when others =>
            Report.Failed
              ("Unexpected exception on EF.Tan with large " &
               "negative value");
      end;
      ...
      exception
         when others =>
            Report.Failed
              ("Unexpected exception on GEF.Tan with small " &
               "positive value");
      end;
      ...
      exception
         when others =>
            Report.Failed
              ("Unexpected exception on EF.Tan with small " &
               "negative value");
      end;
      ...
      if Gef.Tan (0.0) /= 0.0 or Ef.Tan (0.0) /= 0.0 then
         Report.Failed
           ("Incorrect result from Tan function with zero " &
      ...
      if not
        (Result_Within_Range (Gef.Tan (0.785_4), 1.0, 0.001) and
         Result_Within_Range (Gef.Tan (0.843_6), 1.124, 0.001) and
         Result_Within_Range (Ef.Tan (Pi), 0.0, 0.001) and
         Result_Within_Range (Ef.Tan (-Pi), 0.0, 0.001) and
         Result_Within_Range (Gef.Tan (0.538_1), 0.597, 0.001) and
         Result_Within_Range (Ef.Tan (0.197_8), 0.200, 0.001))
      then
         Report.Failed
           ("Incorrect result from Tan function with various " &
            "input parameters");
      end if;
      ...
      if New_Float'Machine_Overflows = True then
         begin
            ...
            Report.Failed
              ("Constraint_Error not raised by GEF.Tan on odd " &
               "multiple of the quarter cycle");
         ...
         exception
            ...
            when others =>
               Report.Failed
                 ("Unexpected exception raised by GEF.Tan on odd " &
                  "multiple of the quarter cycle");
         end;
      end if;
      ...
      begin
         ...
         Report.Failed
           ("Argument_Error not raised by GEF.Tan when Cycle " &
      ...
      exception
         ...
         when others =>
            Report.Failed
              ("Unexpected exception raised by GEF.Tan when Cycle " &
               "parameter has negative value");
      end;
      ...
      exception
         ...
         when others =>
            Report.Failed
              ("Unexpected exception raised by EF.Tan when Cycle " &
               "parameter has a zero value");
      end;
      ...
      exception
         when others =>
            Report.Failed
              ("Unexpected exception on GEF.Tanh with large " &
               "positive value");
      end;
      ...
      exception
         when others =>
            Report.Failed
              ("Unexpected exception on EF.Tanh with large " &
               "negative value");
      end;

      -- Check for prescribed result of Tanh with zero value input parameter.

      if Gef.Tanh (0.0) /= 0.0 or Ef.Tanh (0.0) /= 0.0 then
      ...
      then
         Report.Failed
           ("Incorrect result from Tanh function with various " &
            "input parameters");
      end if;
      ...
      if New_Float'Machine_Overflows = True then
         begin
            ...
            Report.Failed
              ("Constraint_Error not raised by Function Arctanh " &
         ...
         exception
            ...
            when others =>
               Report.Failed
                 ("Unexpected exception raised by Function Arctanh " &
                  "when provided a parameter value of 1.0");
         end;
      end if;
      ...
      begin
         ...
         Report.Failed
           ("Argument_Error not raised by Function Arctanh " &
      ...
      if Gef.Arctanh (0.0) /= 0.0 or Ef.Arctanh (0.0) /= 0.0 then
         Report.Failed
           ("Incorrect result from Function Arctanh with a " &
      ...
      if not
        (Result_Within_Range (Gef.Arctanh (0.15), 0.151, 0.001) and
      ...
      then
         Report.Failed
           ("Incorrect result from Arctanh function with " &
