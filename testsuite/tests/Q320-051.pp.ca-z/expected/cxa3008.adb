...
procedure Cxa3008 is
   ...
   procedure Test_Wide_Wide_Strings
     (Lc_Wide_Wide_String_1 : in Wide_Wide_String;
      ...
      Uc_Wide_Wide_String_2 : in Wide_Wide_String)
   is
   begin
      ...
      if Awwch.To_Upper (Awwch.To_Lower (Uc_Wide_Wide_String_2)) /=
        Uc_Wide_Wide_String_2 or
        Awwch.To_Lower (Awwch.To_Upper (Lc_Wide_Wide_String_2)) /=
          Lc_Wide_Wide_String_2
      then
...
begin
   ...
   Wide_Wide_Character_Block : declare
   ...
   begin
      ...
      for I in Wide_Wide_Character'Pos ('A') .. Wide_Wide_Character'Pos ('Z')
      loop
      ...
      if not (Awwch.To_Upper ('F') = 'F' and Awwch.To_Upper ('U') = 'U') then
      ...
      if Awwch.To_Upper (Awwch.To_Lower ('A')) /= 'A' then
   ...
   exception
      ...
      when others =>
         Report.Failed ("Exception raised in Wide_Wide_Character_Block");

   end Wide_Wide_Character_Block;

   Greek_Wide_Wide_Character_Block : declare
   ...
   begin
      ...
      if Awwch.To_Upper
          (Awwch.To_Lower (Wide_Wide_Character'Val (16#0391#))) /=
        Wide_Wide_Character'Val (16#0391#) -- Capital Alpha
      then
   ...
   exception
      ...
      when others =>
         Report.Failed ("Exception raised in Greek_Wide_Wide_Character_Block");

   end Greek_Wide_Wide_Character_Block;

   Wide_Wide_String_Block : declare
   ...
   exception
      ...
      when others =>
         Report.Failed ("Exception raised in Wide_Wide_String_Block");

   end Wide_Wide_String_Block;

   Greek_Wide_Wide_String_Block : declare
   ...
   exception
      ...
      when others =>
         Report.Failed ("Exception raised in Greek_Wide_Wide_String_Block");
