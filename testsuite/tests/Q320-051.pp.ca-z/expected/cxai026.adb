...
--      Ada.Containers.Bounded_Doubly_Linked_Lists. Each of the subprograms is
...
begin
   ...
   if My_List_1.Length /= 1 then
      Report.Failed ("Unexpected vector length");
   end if;

   declare

      My_Constant_Reference : My_Bounded_Doubly_Linked_Lists
   ...
   declare
      ...
      My_Reference : My_Bounded_Doubly_Linked_Lists.Reference_Type :=
   ...
   begin
      ...
      for C in My_List_1.Iterate loop
         ...
         exit when My_Bounded_Doubly_Linked_Lists."=" (C, My_Cursor_1);
      ...
      for I in Array_Bounds_Type loop
         ...
         My_Bounded_Doubly_Linked_Lists.Next (Position => My_Cursor_1);
