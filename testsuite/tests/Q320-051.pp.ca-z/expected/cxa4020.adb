...
begin
   ...
   begin
            ...
            case I is
               ...
               when others =>
                  if B10.Trim (Bnd_Array (I), As.Both) /= Text then
                     Report.Failed
                       ("Incorrect result from Function Trim - " &
                        Integer'Image (I));
                  end if;
            end case;
         end loop;
      ...
      B10.Trim (Source => Test_String, Left => Cd_Set, Right => Xy_Set);
      ...
      if B10.Tail (B10.Null_Bounded_Wide_String, 3, Translate (' ')) /=
        ...
        B10.Tail (Atoe_Bnd_Str, B10.To_Wide_String (Atoe_Bnd_Str)'First) /=
      ...
      if B10.Replicate (5, Translate ("X")) /=
        ...
        B10.Replicate (10, "") /= B10.Null_Bounded_Wide_String or
        B10.Replicate (0, Translate ("ab")) /= B10.Null_Bounded_Wide_String
      then
