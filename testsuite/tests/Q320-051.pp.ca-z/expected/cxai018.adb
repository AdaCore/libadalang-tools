...
--      reference subprograms contained in package Ada.Containers.Vectors.
...
begin
   ...
   declare
      ...
      My_Constant_Reference : My_Vectors.Constant_Reference_Type :=
        My_Vector_1.Constant_Reference (Index => My_Vector_1.First_Index);
   ...
   declare
      ...
      My_Constant_Reference : My_Vectors.Constant_Reference_Type :=
        My_Vector_1.Constant_Reference (Position => My_Vector_1.First);
   ...
   begin
      ...
      Test
        (Value =>
           My_Vectors.Constant_Reference (My_Vector_1, Index => My_Index_1)
             .Element.all,
      ...
      Test
        (Value =>
           My_Vectors.Constant_Reference (My_Vector_1, Position => My_Cursor_1)
             .Element.all,
      ...
      Test
        (Value     => My_Vector_1.Constant_Reference (Index => My_Index_1),
      ...
      Test
        (Value     => My_Vector_1.Constant_Reference (Position => My_Cursor_1),
      ...
      Test
        (Value     => My_Vector_1 (My_Index_1), -- Constant_Indexing
      ...
      Test
        (Value     => My_Vector_1 (My_Cursor_1), -- Constant_Indexing
