...
package Fxf3a00 is
   ...
   Number_Of_Foreign_Strings : constant :=
     Number_Of_Ff_Strings + Number_Of_Dm_Strings + Number_Of_Chf_Strings;
   ...
   type Picture_String_Array_Type is array (Integer range <>) of Str_Ptr;
