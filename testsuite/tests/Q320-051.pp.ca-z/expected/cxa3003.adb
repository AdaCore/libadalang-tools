...
begin
   ...
   Report.Test
     ("CXA3003",
      "Check that the functions defined in package " &
   ...
   Test_Block : declare
      ...
      Char_5, Tc_Char_5 : Character := Ada.Characters.Latin_1.Lc_W;   -- w
      ...
      Str_1, Tc_Str_1 : String (1 .. 5) := "ABCDE";

      Str_2, Tc_Str_2 : String (1 .. 5) := "#$%^&";

      -- Non-ISO_646 Strings

      Str_3 : String (1 .. 8) := "$123.45" & Ada.Characters.Latin_1.Cent_Sign;
      Tc_Str_3 : String (1 .. 8) := "$123.45*";

      Str_4 : String (1 .. 7) :=
        "abc" & Ada.Characters.Latin_1.Cedilla & "efg";
      ...
      exception
         when others =>
            Report.Failed ("Exception in Validate_Character");
      ...
      exception
         when others =>
            Report.Failed ("Exception in Validate_String");
            return Str;
      end Validate_String;
