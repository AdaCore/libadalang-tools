...
begin
   ...
   Report.Test
     ("CB41001",
      "Check that the 'Identity attribute returns " &
   ...
   declare
      ...
      An_Exception_Id : Ada.Exceptions.Exception_Id := Ada.Exceptions.Null_Id;
      ...
      begin
         ...
         Report.Failed
           ("User defined exception not raised by " &
      ...
      exception
         when Proc_Excpt : A_User_Defined_Exception => -- Expected exception.
            begin
               ...
               Report.Failed
                 ("Hidden_Exception not raised by " &
                  "procedure Propagate_User_Exception");
            exception
               when others =>
         ...
         when others =>
            Report.Failed
              ("Unexpected exception raised by " &
               "Procedure Propagate_User_Exception");
   ...
   begin
      ...
      begin
         ...
         Report.Failed
           ("User defined exception not propagated from " &
            "procedure Propagate_User_Exception");
         ...
         begin
            ...
            exception
               when Excpt : Constraint_Error =>  -- Expected exception.
                  ...
                  Report.Failed
                    ("Predefined exception not raised from " &
      ...
      exception
         ...
         when others =>
            Report.Failed
              ("Unexpected exception handled after second " &
