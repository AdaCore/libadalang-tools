...
begin
   ...
   Test
     ("CD2A53E",
      ...
      "THE TYPE IS PASSED AS A GENERIC ACTUAL " & "PARAMETER");
   ...
   declare
      ...
      begin -- FUNC
         ...
         if Fixed_Element (Cneg1 * Ident (Cpos1)) not in
             -2.437_5 .. -2.187_5 or
           Fixed_Element (Ident (Cneg2) / Cpos2) not in -0.125 .. -0.062_5 then
         ...
         if Ident (Charray (2)) not in 0.625 .. 0.687_5 or
           ...
           Ident (Charray (1)) in -1.0 .. -0.437_5 then
         ...
         if Ident (Chrec.Compf) + Chrec.Compp not in -2.875 .. -2.812_5 or
           Chrec.Compl - Ident (Chrec.Compp) not in 2.812_5 .. 2.875 then
         ...
         if Ident (Chrec.Compp) not in 0.625 .. 0.687_5 or
           ...
           Ident (Chrec.Compn) in -1.0 .. -0.437_5 then
