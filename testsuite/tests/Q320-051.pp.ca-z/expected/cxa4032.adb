...
begin
   ...
   begin
      ...
      exception
         ...
         when others =>
            Report.Failed
              ("Unexpected exception raised by Replace_Slice" &
      ...
      begin                -- Position not in Source'First..Source'Last + 1
         Unb.Overwrite
           (Source   => Tc_Unb_String,
            ...
            New_Item => Tc_String_5);
         Report.Failed
           ("Index_Error not raised by Overwrite when Position " &
            "not in the range Source'First..Source'Last+1");
      exception
         when Index_Error =>
            null;  -- OK, expected exception.
      ...
      Unb.Head (Source => Tc_Unb_String, Count => 0, Pad => '*');
      ...
      Unb.Head (Source => Tc_Unb_String, Count => 4, Pad => '*');
      ...
      Unb.Tail (Source => Tc_Unb_String, Count => 0, Pad => '*');
      ...
      Unb.Tail (Source => Tc_Unb_String, Count => 6, Pad => '*');
