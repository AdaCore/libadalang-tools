...
begin
   ...
   declare
      ...
      type Document_Type is
        array (Positive range <>) of Asunb.Unbounded_String;
         ...
         Document (1) :=
           Asunb.Overwrite
             (Document (1),
              Asunb.Index
                (Document (1),
                 Asunb.To_String (Asunb.Tail (Document (1), 8, ' ')),
         ...
         Document (1) :=
           Asunb.Overwrite
             (Document (1),
              Asunb.Index
                (Document (1),
                 Asunb.To_String (Asunb.Tail (Document (1), 5, ' ')),
                 Ada.Strings.Backward),
      ...
      begin
         ...
         Camera_Copy (4) (1 .. Asunb.Length (Document (2))) :=
           Asunb.To_String
             (Asunb.Head (Document (2), Asunb.Length (Document (2))));
