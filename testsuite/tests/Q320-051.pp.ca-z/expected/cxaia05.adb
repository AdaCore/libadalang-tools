...
procedure Cxaia05 is
   ...
   begin
      ...
      return Ada.Containers.Hash_Type
          (Character'Pos (Element (Element'First))) *
        17; -- Some prime

   end My_Element_Hash;

   function My_Equivalent_Elements (Left, Right : String) return Boolean is
   begin
   ...
   procedure Tampering_Check
     (Container : in out My_Indefinite_Hashed_Sets.Set; Where : in String)
   is
...
begin
   ...
   declare
      ...
      procedure My_Process (Position : in My_Indefinite_Hashed_Sets.Cursor) is
      begin
   ...
   if My_Indefinite_Hashed_Sets.Overlap (Left => My_Set_3, Right => My_Set_2)
   then
   ...
   My_Set_3 :=
     My_Indefinite_Hashed_Sets.Union (Left => My_Set_1, Right => My_Set_2);
   ...
   My_Set_3 :=
     My_Indefinite_Hashed_Sets.Intersection
   ...
   My_Set_3 :=
     My_Indefinite_Hashed_Sets.Difference
       (Left => My_Set_1, Right => My_Set_2);
   ...
   My_Set_3 :=
     My_Indefinite_Hashed_Sets.Symmetric_Difference
