...
begin
   ...
   declare
      ...
      type System_File_Array_Type is array (Integer range <>) of File_Access;
      ...
      procedure Restore_Initial_Environment
        (Initial_Env : System_File_Array_Type)
      is
      begin
      ...
      begin
         ...
         if Str_1 (1 .. Len_1) /= Line_1 or Str_2 (1 .. Len_2) /= Line_2 then
         ...
         if Str_5 (1 .. Len_5) /= Line_5 or Str_6 (1 .. Len_6) /= Line_6 then
