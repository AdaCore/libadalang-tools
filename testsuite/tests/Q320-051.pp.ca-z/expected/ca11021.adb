...
begin
   ...
   Report.Test
     ("CA11021",
      "Check that body of the generic parent package " &
   ...
   if Real_Part (Complex_Two) /= 55 and Imag_Part (Complex_Two) /= 30 then
   ...
   if Real_Part (Complex_Two) /= 12 and Imag_Part (Complex_Two) /= -21 then
      Report.Failed ("Incorrect results from complex operation");
   end if;
