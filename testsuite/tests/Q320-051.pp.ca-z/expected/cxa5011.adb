...
begin
   ...
   Test_Block : declare
      ...
      package Float_String_Pack is new Generic_Bounded_Length
      ...
      begin
         ...
         State_String_1 :=
           Float_String_Pack.To_Bounded_String
             (Source => Float_Random.Image (Of_State => State_1));
      ...
      begin
         ...
         Discrete_Package.Save (Gen => Gen_1, To_State => State_1);
         Discrete_Package.Save (Gen_2, To_State => State_2);

         State_String_1 :=
           Discrete_String_Pack.To_Bounded_String
             (Source => Discrete_Package.Image (Of_State => State_1));

         State_String_2 :=
           Discrete_String_Pack.To_Bounded_String
             (Source => Discrete_Package.Image (Of_State => State_2));
