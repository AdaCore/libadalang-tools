...
begin
   ...
   declare
      ...
      User_Exception_1, User_Exception_2, User_Exception_3 : exception;
      Not_Raised_Exception_4                               : exception;

      type String_Ptr is access String;

      User_Messages : constant array
        (1 .. Number_Of_Exceptions + 1) of String_Ptr :=
        (new String'("Msg"),
         new String'
           ("This message will override the default " &
            "message provided by the implementation"),
         new String'
           ("The message can be captured by procedure" & -- 200 chars
         ...
         new String'
           ("The message from an exception that will " & "be raised."),
         new String'
           ("A different message than the one usually " &
   ...
   begin
      ...
      exception
         ...
         when others =>
            Report.Failed ("Unexpected exception handled - 1");
      end;
      ...
      begin
         ...
         begin
            Counter :=
              (if User_Messages (4).all (1) = 'G' then 10
         ...
         exception
            ...
            when others =>
               Report.Failed ("User_Exception_2 not handled");
         end;
      ...
      exception
         ...
         when others =>
            Report.Failed ("Unexpected exception handled - 2");
      end;
      ...
      begin
         ...
         declare
            Flag : Boolean :=
              (User_Messages (5).all (1) = 'A'
               or else raise Not_Raised_Exception_4
                 with User_Messages (5).all);
         begin
            if not Flag then
      ...
      exception
         ...
         when others =>
            Report.Failed ("Unexpected exception handled - 3");
      end;
