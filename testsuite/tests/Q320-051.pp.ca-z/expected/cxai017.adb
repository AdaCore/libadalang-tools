...
procedure Cxai017 is
   ...
   type My_Constrained_Array_Type is
     array (Constrained_Array_Bounds_Type) of My_Float;
   ...
   Value_Array : My_Array_Type := Unsorted_Value_Array;
   ...
   begin
      ...
      Value_Vector.Swap (I => Left, J => Right);
...
begin
   ...
   for I in Constrained_Array_Bounds_Type loop
      ...
      Unsorted_Vector.Append
        (New_Item => Unsorted_Value_Constrained_Array (I));
   ...
   My_Array_Sort_2 (First => Value_Array'First, Last => Value_Array'Last);
