...
--      contained in package Ada.Containers.Unbounded_Priority_Queues.
...
procedure Cxai035 is

   package My_Synchronized_Queue_Interfaces is new Ada.Containers
   ...
   package My_Unbounded_Priority_Queues is new Ada.Containers
   ...
   My_Queue_1 : My_Unbounded_Priority_Queues.Queue;
   My_Queue_2 : My_Unbounded_Priority_Queues.Queue;
   ...
   begin
      ...
      for I in Array_Bounds_Type loop
         ...
         Value_In_Array (I) := (-1.234_5)**Integer (I);
   ...
   begin
      ...
      for I in Array_Bounds_Type loop
         ...
         My_Queue_2.Enqueue (New_Item => Value_In_Array (I));
...
begin
   ...
   for I in Array_Bounds_Type loop
      ...
      My_Queue_2.Dequeue (Element => Value_Out_Array (I));
