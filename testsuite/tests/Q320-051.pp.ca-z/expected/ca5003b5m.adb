...
-- LIBRARY PACKAGES MUST BE ELABORATED IN ORDER: _B0, _B3, _B1. PARENT UNITS
-- MUST BE ELABORATED BEFORE THEIR SUBUNITS.
...
begin
   Test
     ("CA5003B",
      "CHECK THAT UNITS IN WITH_CLAUSES OF " &
      "SUBUNITS ARE ELABORATED PRIOR TO THE " & "BODY OF THE ANCESTOR UNIT");
