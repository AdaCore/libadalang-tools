...
procedure Cxaia11 is
   ...
   package My_Indefinite_Ordered_Maps is new Ada.Containers
...
begin
   ...
   declare
      ...
      My_Constant_Reference : My_Indefinite_Ordered_Maps
   ...
   begin
      ...
      Test
        (Value =>
           My_Indefinite_Ordered_Maps.Constant_Reference
      ...
      Test_And_Mod
        (Value =>
           My_Indefinite_Ordered_Maps.Reference
             (My_Map_1, Key => My_Key_Type (1))
             .Element.all,
   ...
   begin
      ...
      for I in Fxaia00.Array_Bounds_Type loop
         ...
         My_Map_1.Insert (Key => My_Key_Type (I), New_Item => "abc");
