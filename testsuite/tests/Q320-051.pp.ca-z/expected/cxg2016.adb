...
procedure Cxg2016 is
   ...
   package body Generic_Check is
      ...
      function Arctan
        (Y : Real; X : Real := 1.0; Cycle : Real) return Real renames
        Elementary_Functions.Arctan;
      ...
      exception
         when Constraint_Error =>
            Report.Failed ("Constraint_Error raised in Taylor_Series_Test");
         when others =>
   ...
   A_Long_Float_Half_Pi_Low : constant :=
     A_Long_Float'Adjacent (Pi / 2.0, 0.0);
   A_Long_Float_Half_Pi_High : constant :=
...
begin
   Report.Test ("CXG2016", "Check the accuracy of the ARCTAN function");
