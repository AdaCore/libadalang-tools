...
procedure Cd30003 is
   ...
   pragma Pack
     (Smallword_Array); -- Required if Storage_Unit > 16. -- ANX-C RQMT.
   ...
   Enum_Size : constant :=
     Integer'Min (32, Integer'Min (Max_Modular'Size, Max_Integer'Size));
   ...
   Modular_Double_Size : constant :=
     Integer'Min
       (((16 + (System.Storage_Unit - 1)) / System.Storage_Unit) *
        System.Storage_Unit,
        Max_Modular'Size);

   Modular_Quad_Size : constant :=
     Integer'Min
       (((32 + (System.Storage_Unit - 1)) / System.Storage_Unit) *
        System.Storage_Unit,
        Max_Modular'Size);

   Array_Quad_Size : constant :=
     ((4 * 8 + (System.Storage_Unit - 1)) / System.Storage_Unit) *
     System.Storage_Unit;

   Array_Octo_Size : constant :=
     ((4 * 16 + (System.Storage_Unit - 1)) / System.Storage_Unit) *
     System.Storage_Unit;

   Rounded_Enum_Size : constant :=
     ((Enum_Size + (System.Storage_Unit - 1)) / System.Storage_Unit) *
     System.Storage_Unit;

   Enum_Quad_Size : constant :=
     Integer'Min
       (((32 + (System.Storage_Unit - 1)) / System.Storage_Unit) *
        System.Storage_Unit,
