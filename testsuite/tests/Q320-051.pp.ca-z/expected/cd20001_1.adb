...
package body Cd20001_1 is
   ...
   begin
      ...
      if Pact_Aray_2'Component_Size > Next_Factor (Bits_2'Size) then
         Report.Failed ("2 bit element Packed Array'Component_Size too big");
      end if;

      Tctouch.Assert
        (Pact_Aray_2'Component_Size <= Pact_Aray_2'Size,
         "2 bit Component_Size greater than array size");

      if Pact_Aray_3'Component_Size > Next_Factor (Bits_3'Size) then
         Report.Failed ("3 bit element Packed Array'Component_Size too big");
      end if;

      Tctouch.Assert
        (Pact_Aray_3'Component_Size <= Pact_Aray_3'Size,
         "3 bit Component_Size greater than array size");

      if Pact_Aray_7'Component_Size > Next_Factor (Bits_7'Size) then
         Report.Failed ("7 bit element Packed Array'Component_Size too big");
      end if;

      Tctouch.Assert
        (Pact_Aray_7'Component_Size <= Pact_Aray_7'Size,
         "7 bit Component_Size greater than array size");

      if Pact_Aray_8'Component_Size > Next_Factor (Bits_8'Size) then
         Report.Failed ("8 bit element Packed Array'Component_Size too big");
      end if;

      Tctouch.Assert
        (Pact_Aray_8'Component_Size <= Pact_Aray_8'Size,
      ...
      if System.Word_Size > 8 then
         ...
         Tctouch.Assert
           (Pact_Aray_9'Component_Size <= Pact_Aray_9'Size,
         ...
         Tctouch.Assert
           (Pact_Aray_15'Component_Size <= Pact_Aray_15'Size,
