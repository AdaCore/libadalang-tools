package body F552a00_Sparse_Arrays is
   ...
   function Has_Element (Position : Cursor) return Boolean is
      Found : constant Boolean :=
        (Position.Container /= null and then Position.Index > 0
   ...
   begin
      return
        (for some Item in Container.Data'Range =>
           Container.Data (Item).Index = Index);
   end Has_Element;

   type Iterator is new Sparse_Array_Iterator_Interfaces
   ...
   begin
      ...
      return (Index => 1, Container => Object.Container);
   end First;
   ...
   begin
      ...
      return (Index => Position.Index + 1, Container => Object.Container);
   end Next;

   function Last (Object : Iterator) return Cursor is
   begin
      Ada.Strings.Unbounded.Append
        (Source => Tc_Call_History, New_Item => 'L');
   ...
   begin
      ...
      if Position.Container = null then
         ...
         raise Program_Error with "Position denotes a different container";
