...
begin
   ...
   Report.Test
     ("CXAA017",
      "Check that Ada.Text_IO subprograms " &
   ...
   Test_Block : declare
      ...
      Udla_End_Of_Line, Udgi_Available : Boolean := False;
   ...
   begin
      ...
      if not End_Of_Line (User_Defined_Input_File) then
         Report.Failed
      ...
      if Char_Pos - 1 /= Tc_String_1'Length then
         Report.Failed
           ("Not all of the characters on the first line " & "were processed");
      end if;
