...
begin
   ...
   Radix_10_Block : declare
      ...
      type Dt_0_0001 is delta 0.000_1 digits 10;
      type Dt_0_00001 is delta 0.000_01 digits 10;
   ...
   begin
      ...
      begin
         if Tc_Verbose then
            Report.Comment ("Case 41");
         end if;
         Dd_0_0001 := (Dt_0_0001 (6_062.0) / Dt_0_0001 (16_384.0));
         Dv_1      := Dt_1 (0.0);
         Div (Dd_0_0001, Dv_1, Quot_0_0001, Rem_0_0001);
         Report.Failed
           ("Divide by Zero didn't raise Constraint_Error, " & "Case 41");
      exception
         when Constraint_Error =>
            null;  -- OK, expected exception.
         when others =>
            Report.Failed
              ("Unexpected exception raised by Divide by Zero," & "Case 41");
      end;

   exception
      when others =>
         Report.Failed ("Exception raised in Radix_2_Block");
   end Radix_2_Block;
