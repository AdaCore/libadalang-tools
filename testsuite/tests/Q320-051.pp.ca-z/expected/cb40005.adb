...
begin  -- Main test procedure.
   ...
   Report.Test
     ("CB40005",
      "Check that exceptions raised in non-generic " &
   ...
   Fail_Soft.Fail_Soft_Call
     (Cause_Visible_Exception'Access,       -- V
   ...
   exception
      when Constraint_Error =>
         Report.Failed ("1: Raised Constraint_Error");
      when Visible_Exception =>
         Report.Failed ("1: Raised Visible_Exception");
      when others =>
         null; -- expected case
   end;
   ...
   exception
      when Constraint_Error =>
         Report.Failed ("2: Raised Constraint_Error");
      when Visible_Exception =>
         null; -- expected case
      when others =>
         Report.Failed ("2: Raised Invisible_Exception");
   end;
   ...
   exception
      when Constraint_Error =>
         null; -- expected case
      when Visible_Exception =>
         Report.Failed ("3: Raised Visible_Exception");
      when others =>
         Report.Failed ("3: Raised Invisible_Exception");
   end;
