...
begin
   ...
   for I in Array_Bounds_Type loop
      ...
      begin
         ...
         if not My_Bounded_Ordered_Sets.Equivalent_Elements
             (Left =>
                My_Bounded_Ordered_Sets.Element (Position => My_Cursor_1),
      ...
      if I mod 2 = 0 then
         ...
         My_Cursor_1 := My_Bounded_Ordered_Sets.Next (Position => My_Cursor_1);
   ...
   declare
      ...
      procedure My_Process (Position : in My_Bounded_Ordered_Sets.Cursor) is
      begin
      ...
      procedure My_Reverse_Process
        (Position : in My_Bounded_Ordered_Sets.Cursor)
      is
      begin
   ...
   if not
     (My_Bounded_Ordered_Sets.Element
   ...
   if not My_Bounded_Ordered_Sets.Has_Element (Position => My_Cursor_1) then
   ...
   My_Set_3 :=
     My_Bounded_Ordered_Sets.Copy
       (Source =>
          My_Bounded_Ordered_Sets.Union (Left => My_Set_1, Right => My_Set_2),
   ...
   begin
      ...
      begin
         ...
         if Inserted then
            ...
            Report.Failed ("4 parameter Insert did not insert new element");
         end if;
