...
procedure Cxc7005 is
   ...
   package Pkg is
      ...
      task type Task_Typ_Task_Attribute_Iface is new Task_Attribute_Iface with
         entry Stop;
   ...
   procedure Check_Attributes_And_Stop
     (Obj    : in out Task_Attribute_Iface'Class;
      Obj_Id : in     Ada.Task_Identification.Task_Id)
   is
   begin
...
begin
   Test
     ("CXC7005",
      "Check that an object of a task interface type can be " &
