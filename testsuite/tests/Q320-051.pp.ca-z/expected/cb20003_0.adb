...
package body Cb20003_0 is                     -- package Push_Buttons
   ...
   procedure Push (B : in out Button; P : in Priority_Type) is
   ...
   procedure Default_Response (P : in Priority_Type; B : in out Button) is
   begin
   ...
   procedure Alert_Response (P : in Priority_Type; B : in out Button) is
   begin
   ...
   procedure Emergency_Response (P : in Priority_Type; B : in out Button) is
   begin
