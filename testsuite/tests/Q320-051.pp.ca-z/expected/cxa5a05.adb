...
begin
   ...
   begin
      ...
      begin
         ...
         Report.Failed
           ("Argument_Error not raised by Arcsin function " &
      ...
      exception
         ...
         when others =>
            Report.Failed
              ("Unexpected exception raised by Arcsin function " &
               "when provided a parameter value larger than 1.0");
      end;
      ...
      if Gef.Arcsin (X => 0.0) /= 0.0 or Ef.Arcsin (0.0) /= 0.0 then
         Report.Failed
           ("Incorrect result from Function Arcsin when the " &
...
--pwb-math
      ...
      begin
         ...
         Report.Failed
           ("Argument_Error not raised by Function Arcsin " &
      ...
      exception
         ...
         when others =>
            Report.Failed
              ("Unexpected exception raised by Function Arcsin " &
               "with specified cycle of 0.0");
      end;
...
--pwb-math      end if;
      ...
      exception
         when others =>
            Report.Failed
              ("Unexpected exception on Arcsinh with large " &
               "positive value");
      end;
      ...
      exception
         when others =>
            Report.Failed
              ("Unexpected exception on Arcsinh with small " &
               "positive value");
      end;
      ...
      if Gef.Arcsinh (X => 0.0) /= 0.0 or Ef.Arcsinh (X => 0.0) /= 0.0 then
         Report.Failed
           ("Incorrect result from Function Arcsinh when " &
