...
package F552a00_Sparse_Arrays is
   ...
   type Sparse_Array (Max_Elements : Count_Type) is tagged private with
...
private
   ...
   type Sparse_Array_Element is record
   ...
   type Data_Array is array (Count_Type range <>) of Sparse_Array_Element;

   type Sparse_Array (Max_Elements : Count_Type) is tagged record
