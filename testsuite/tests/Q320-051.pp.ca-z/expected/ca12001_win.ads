...
package Ca12001_Win is
   ...
   procedure Create
     (Window : in out Window_Type; Id : in Window_Id_Type;
   ...
   procedure Create
     (Window : in out Window_Type; Parent : in out Window_Type'Class;
      Id : in Window_Id_Type; Width : in Window_Size; Height : in Window_Size);
   ...
   procedure Resize
     (Window : in Window_Type; Width : in Window_Size;
