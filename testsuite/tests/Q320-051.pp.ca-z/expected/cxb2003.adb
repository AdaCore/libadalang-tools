...
begin
   ...
   begin
      ...
      if Shift_Right (Tc_Val_Unsigned_32, 0) /= Unsigned_32'Last or
        Shift_Right (Tc_Val_Unsigned_32, 2) /=
          Unsigned_32'Last - (2**31 + 2**30)
      then
      ...
      Tc_Result_Unsigned_32 :=
        Shift_Right_Arithmetic (Tc_Val_Unsigned_32, Tc_Amount);
      ...
      if Tc_Result_Unsigned_32 /= (2**31 + 2**30) then
         Report.Failed ("Incorrect result from Shift_Right_Arithmetic - 3");
      end if;
      ...
      if Tc_Result_Unsigned_32 /= (2**31 + 2**30 + 2**0) then
         Report.Failed ("Incorrect result from Shift_Right_Arithmetic - 4");
      end if;
      ...
      if Shift_Right_Arithmetic (Tc_Val_Unsigned_32, 0) /=
        ...
        Shift_Right_Arithmetic (Tc_Val_Unsigned_32, 3) /=
          (2**31 + 2**30 + 2**29 + 2**28)
      then
         Report.Failed ("Incorrect result from Shift_Right_Arithmetic - 5");
      end if;
      ...
      Tc_Val_Unsigned_32    := Unsigned_32'Last;
      Tc_Result_Unsigned_32 :=
        Rotate_Left (Value => Tc_Val_Unsigned_32, Amount => Tc_Amount);
      ...
      Tc_Result_Unsigned_32 :=
        Rotate_Right (Value => Tc_Val_Unsigned_32, Amount => Tc_Amount);
      if Tc_Result_Unsigned_32 /= (2**31 + 2**30) then
