...
package Cxac007_Logger with
 ...
 is
   ...
   -- name here since it is generated by the Report package, which is not
   -- Preelaborated. In a real program, the name would most likely come from
   -- a constant or function declared in this package rather than being passed.
