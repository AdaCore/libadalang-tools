...
--      Ada.Containers.Bounded_Hashed_Sets. Each of the subprograms is
...
begin
   ...
   begin
      ...
      Test
        (Value =>
           My_Bounded_Hashed_Sets.Constant_Reference
             (My_Set_1,
   ...
   begin
      ...
      for E of My_Set_1 loop
         ...
         Tampering_Check (Container => My_Set_1, Where => "reading of loop");
      ...
      for C in My_Set_1.Iterate loop
         ...
         Tampering_Check (Container => My_Set_1, Where => "reading in loop");
