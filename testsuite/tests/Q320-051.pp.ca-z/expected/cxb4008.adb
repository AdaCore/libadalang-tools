...
begin
   ...
   declare
      ...
      type Decimal_Type_4 is delta 0.000_1 digits Max_Digits_Long_Binary;
      ...
      Tc_Dec_1       : Decimal_Type_1 := 12_345.0;
      Tc_Dec_2       : Decimal_Type_2 := 123_456.00;
      Tc_Dec_3       : Decimal_Type_3 := 1_234_567.000;
      Tc_Dec_4       : Decimal_Type_4 := 12_345_678.000_0;
   ...
   begin
      ...
      if Pack_1.To_Decimal (Item => Pack_1.To_Binary (1_234.0)) /= 1_234.0 then
         Report.Failed
           ("Incorrect result from function To_Decimal with " &
            "Binary parameter - 2");
      end if;
      ...
      Tc_Dec_3 := 9.001;
      Tc_Dec_4 := 123.456_7;
      if Pack_3.To_Long_Binary (Tc_Dec_3) =
        Pack_3.To_Long_Binary (-Tc_Dec_3) or
      ...
      if Pack_3.To_Long_Binary (1.011) = Pack_3.To_Long_Binary (-1.011) or
        Pack_4.To_Long_Binary (2_345_678.901_2) =
          Pack_4.To_Long_Binary (-2_345_678.901_2)
      then
