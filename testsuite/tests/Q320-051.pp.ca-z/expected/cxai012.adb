...
procedure Cxai012 is
   ...
   procedure Tampering_Check
     (Container : in out My_Bounded_Hashed_Maps.Map; Where : in String) with
...
begin
   ...
   for I in Array_Bounds_Type loop
      ...
      My_Map_1.Insert (Key => My_Key_Type (I), New_Item => Value_In_Array (I));
   ...
   for I in Array_Bounds_Type loop
      ...
      declare
         ...
         procedure My_Query (Key : in My_Key_Type; Element : in My_Float) is
         begin

            Tampering_Check (Container => My_Map_1, Where => "Query_Element");
   ...
   for I in reverse Array_Bounds_Type loop
      ...
      My_Map_2.Insert (Key => My_Key_Type (I), New_Item => Value_In_Array (I));
   ...
   declare
      ...
      procedure My_Process (Position : in My_Bounded_Hashed_Maps.Cursor) is
      begin
   ...
   for I in Array_Bounds_Type loop
      ...
      declare
         ...
         begin
            ...
            Tampering_Check (Container => My_Map_2, Where => "Update_Element");
   ...
   begin
      ...
      begin
         ...
         if Inserted then
            ...
            Report.Failed ("5 parameter Insert did not insert new key");
         end if;
   ...
   begin
      ...
      begin
         ...
         if Inserted then
            ...
            Report.Failed ("4 parameter Insert did not insert new key");
         end if;
   ...
   begin
      ...
      My_Map_2.Insert (Key => 3, New_Item => Value_In_Array (1));
   ...
   begin
      ...
      My_Map_2.Insert (Key => 6, New_Item => Value_In_Array (7));
   ...
   begin
      ...
      My_Map_2.Include (Key => 6, New_Item => Value_In_Array (2));
   ...
   begin
      ...
      My_Map_2.Replace (Key => 4, New_Item => Value_In_Array (1));
   ...
   if My_Map_2.Element (Key => 1) /= Value_In_Array (2) then
   ...
   if My_Map_2.Element (Key => 3) /= Value_In_Array (1) then

      Report.Failed ("Inserted value not as expected #3");

   end if;

   if My_Map_2.Element (Key => 4) /= Value_In_Array (1) then

      Report.Failed ("Inserted value not as expected #4");

   end if;

   if My_Map_2.Element (Key => 5) /= My_Default_Value then
   ...
   if My_Bounded_Hashed_Maps.Equivalent_Keys
       (Left  => My_Map_1.First,
        Right => My_Bounded_Hashed_Maps.Next (My_Map_1.First))
   then
   ...
   if My_Bounded_Hashed_Maps.Equivalent_Keys
       (Left  => My_Map_1.First,
        Right =>
          My_Bounded_Hashed_Maps.Key
            (My_Bounded_Hashed_Maps.Next (My_Map_1.First)))
   then
   ...
   if not My_Bounded_Hashed_Maps.Equivalent_Keys
       (Left  => My_Map_1.First,
        Right => My_Bounded_Hashed_Maps.Key (My_Map_1.First))
   then
