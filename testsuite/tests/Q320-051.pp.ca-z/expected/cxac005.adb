...
procedure Cxac005 is
   ...
   package Checked_Stream_Io is
      ...
      procedure Open
        (File : in out File_Type; Mode : in Stream_Io.File_Mode;
         Name : in     String; Form : in String := "");
      ...
      procedure Read
        (File : in out File_Type; Item : out Stream_Element_Array;
      ...
      procedure Write
        (File : in out File_Type; Item : in Stream_Element_Array;
      ...
      procedure Set_Index
        (File : in out File_Type; To : in Stream_Io.Positive_Count);
   ...
   package body Checked_Stream_Io is
      ...
      begin
         ...
         if Mode = Append_File then
            Tc_Assert
              (File.Index = Stream_Io.Size (File.File) + 1,
               "Index /= Size + 1 -- Create - Append_File");
         else
            Tc_Assert
              (File.Index = 1,
               "Index /= 1 -- Create - " & File_Mode'Image (Mode));
         end if;
      end Create;
      ...
      begin
         ...
         if Mode = Append_File then
            ...
            Tc_Assert
              (File.Index = 1,
               "Index /= 1 -- Open - " & File_Mode'Image (Mode));
         end if;
      end Open;
      ...
      begin
         ...
         if Mode = Append_File then
            ...
            Tc_Assert
              (File.Index = 1,
               "Index /= 1 -- Reset - " & File_Mode'Image (Mode));
         end if;
      end Reset;
      ...
      begin
         ...
         if Last < Item'Last then
            ...
            Tc_Assert
              (Count (Index + Last - Item'First) = Stream_Io.Size (File.File),
               "Read stopped before end of file");
            File.Index := Count (Index + Last - Item'First) + 1;
         else
            Tc_Assert
              (Item = File.Contents (Index .. Index + Item'Length - 1),
...
begin
   ...
   begin
      ...
      exception
         when others =>
            Not_Applicable
              ("Files not supported - Creation with Out_File for Stream_IO");
            raise Incomplete;
      end;
      ...
      declare
         S : Stream_Element_Array (1 .. Stream_Element_Offset (Csio.Size (F)));
      begin
