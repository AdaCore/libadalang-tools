...
begin
   ...
   Report.Test
     ("CXB4007",
      "Check that functions Valid, Length, To_Decimal " &
   ...
   begin
      ...
      Tc_Valid :=
        (Pack_2.Valid
           (Pack_2.To_Binary (Tc_Dec_2, High_Order_First),
            Format => High_Order_First) and
         Pack_2.Valid
           (Pack_2.To_Binary (0.01, Low_Order_First),
            Format => Low_Order_First));
      ...
      if not Pack_3.Valid
          (Item   => Pack_3.To_Binary (Tc_Dec_3, Low_Order_First),
      ...
      if Pack_1.Valid
          (Item   => Pack_2.To_Binary (Tc_Dec_2, Low_Order_First),
           Format => Low_Order_First) or
        Pack_2.Valid
      ...
      if not
        (Pack_1.Length (Native_Binary) >= Tc_Min_Length and
      ...
      begin
         Tc_Dec_4 := 99_999.900_1;
         Tc_Dec_1 :=
           Pack_1.To_Decimal
             (Pack_4.To_Binary (Tc_Dec_4, Native_Binary),
              Format => Native_Binary);
         if Tc_Dec_1 = 99_999.9 then
            Report.Comment
              ("Minimize dead assignment optimization -- " &
