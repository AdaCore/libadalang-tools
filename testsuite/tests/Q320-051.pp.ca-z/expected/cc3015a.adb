...
--*
-- CHECK THAT WHEN A GENERIC PACKAGE INSTANTIATION IS ELABORATED, STATEMENTS
-- IN ITS PACKAGE BODY ARE EXECUTED AND EXPRESSIONS REQUIRING EVALUATION ARE
-- EVALUATED (E.G., DEFAULTS FOR OBJECT DECLARATIONS ARE EVALUATED).
