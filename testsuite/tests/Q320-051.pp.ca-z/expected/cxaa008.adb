...
begin
   ...
   Operational_Test_Block : declare
      ...
      type Item_Type is delta 0.1 range 0.0 .. 5_000.0;
      type Cost_Type is delta 0.01 range 0.0 .. 10_000.0;
      type Profit_Type is delta 0.01 range -100.0 .. 1_000.0;
      ...
      begin
         case Selector is
            when 1 =>
               return Text_Io.In_File;
            when 2 =>
               return Text_Io.Out_File;
            when others =>
               return Text_Io.Append_File;
         end case;
