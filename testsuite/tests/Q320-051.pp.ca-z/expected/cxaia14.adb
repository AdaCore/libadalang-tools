...
procedure Cxaia14 is
   ...
   package My_Indefinite_Multiway_Trees is new Ada.Containers
...
begin
   ...
   declare
      ...
      My_Constant_Reference : My_Indefinite_Multiway_Trees
        .Constant_Reference_Type :=
        My_Tree_1.Constant_Reference
          (Position =>
             My_Indefinite_Multiway_Trees.First_Child (Parent => Root_1));
   ...
   begin
      ...
      for I in Fxaia00.Array_Bounds_Type loop
         ...
         My_Tree_1.Append_Child (Parent => Root_1, New_Item => "abc");
