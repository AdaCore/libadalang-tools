...
--      Ada.Containers.Bounded_Hashed_Maps. Each of the subprograms is
...
--      20 Nov 14   RLB     Corrected package name in test message.
--
--!
with Ada.Containers.Bounded_Hashed_Maps;
with Report;

procedure Cxai027 is
...
begin
   ...
   declare
      ...
      My_Constant_Reference : My_Bounded_Hashed_Maps.Constant_Reference_Type :=
   ...
   declare
      ...
      My_Reference : My_Bounded_Hashed_Maps.Reference_Type :=
   ...
   begin
      ...
      for E of My_Map_1 loop
         ...
         Tampering_Check (Container => My_Map_1, Where => "reading of loop");
      ...
      for C in My_Map_1.Iterate loop
         ...
         Tampering_Check (Container => My_Map_1, Where => "reading in loop");
