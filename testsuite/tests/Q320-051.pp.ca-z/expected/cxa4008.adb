...
begin
   ...
   begin
      ...
      Result_String :=
        B10.Append
          (B10.To_Bounded_String ("abcdefgh"), -- 8 chs
      ...
      if B10.Count
          (B10.To_Bounded_String ("ABABABABAB"),
           "ABA",
           Maps.Identity) /=
        2 or
        B10.Count
            (B10.To_Bounded_String ("ADCBADABCD"),
             "AB",
      ...
      B10.Translate (Test_String, Maps.To_Mapping ("aeiou", "AEIOU"));
      ...
      Result_String :=
        B10.Insert
          (Source   => B10.To_Bounded_String ("abcdef"),
           Before   => 2,
      ...
      if B10.Insert (B10.To_Bounded_String ("a"), 1, " B") /=
        ...
        B10.Insert (B10.Null_Bounded_String, 1, "abcde") /= Atoe_Bnd_Str or
      ...
      B10.Insert (Test_String, B10.To_String (Test_String)'First, "Z");
