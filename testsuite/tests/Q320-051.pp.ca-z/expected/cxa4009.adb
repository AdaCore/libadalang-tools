   ...
   begin
      ...
      if B10.Delete
        ...
        B10.Delete (Atoj_Bnd_Str, 6, B10.Length (Atoj_Bnd_Str)) /=
          Atoe_Bnd_Str or
        B10.Delete (Atoj_Bnd_Str, 1, 5) /= Ftoj_Bnd_Str or
      ...
      if B10.Trim (Atoe_Bnd_Str, Maps.Null_Set, Maps.Null_Set) /=
        Atoe_Bnd_Str or
        B10.Trim (B10.To_Bounded_String ("dcddcxyyxx"), Cd_Set, Xy_Set) /=
      ...
      if B10.Tail (B10.Null_Bounded_String, 3, ' ') /=
        B10.To_Bounded_String ("   ") or
        B10.Tail (Atoe_Bnd_Str, B10.To_String (Atoe_Bnd_Str)'First) /=
