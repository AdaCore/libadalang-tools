...
begin
   ...
   begin
      ...
      Result_String :=
        B10.Append
          (B10.To_Bounded_Wide_String (Equiv ("abcdefgh")), -- 8 chs
      ...
      if B10.Index
          (B10.To_Bounded_Wide_String ("dog"),   -- Pattern = Source
           "cat",
           Ada.Strings.Forward,
           Map_Ptr) /=
        1 or
      ...
      if B10.Count
          (B10.To_Bounded_Wide_String (Equiv ("ABABABABAB")),
           Equiv ("ABA"),
           Maps.Identity) /=
        2 or
        B10.Count
            (B10.To_Bounded_Wide_String ("ADCBADABCD"),
             "AB",
             Maps.To_Mapping ("CD", "AB")) /=
          5 or
        B10.Count
            (B10.To_Bounded_Wide_String (Equiv ("aaaaaaaaaa")),
             Equiv ("aaa")) /=
          3 or
        B10.Count
            (B10.To_Bounded_Wide_String (Equiv ("XX")),
             Equiv ("XXX"),
             Maps.Identity) /=
          0 or
        B10.Count
      ...
      if B10.Count
        ...
        B10.Count
          ...
          1 or
        B10.Count
            (B10.To_Bounded_Wide_String ("dddddddddd"),
             "ccccc",
             Map_Ptr) /=
          2 or
        B10.Count
      ...
      B10.Translate (Test_String, Maps.To_Mapping ("abcde", "lmnop"));
      ...
      exception
         ...
         when Constraint_Error =>
            null;  -- Also OK, since RM is not clear
         when others =>
            Report.Failed
              ("Incorrect exception raised by Function Replace_Slice");
      end;
      ...
      Result_String :=
        B10.Insert
          (Source   => B10.To_Bounded_Wide_String ("abcdef"),
           Before   => 2,
      ...
      B10.Insert (Test_String, B10.To_Wide_String (Test_String)'First, "Z");
