...
begin
   ...
   declare
      ...
      My_Vector_3 : My_Indefinite_Vectors.Vector := My_Vector_1;

      I : Fxaia00.Array_Bounds_Type := Fxaia00.Array_Bounds_Type'First;

      procedure My_Process (Position : in My_Indefinite_Vectors.Cursor) is
      begin
   ...
   -- The order should now be Default_Value, Value_In_Ptr_Array (1).all,
   -- Default_Value, Default_Value, Value_In_Ptr_Array (1).all, Default_Value,
   -- Value_In_Ptr_Array (2).all, Value_In_Ptr_Array (2).all, Default_Value,
   -- Value_In_Ptr_Array (2).all, Value_In_Ptr_Array (2).all, Default_Value
   ...
   -- Value_In_Ptr_Array (2).all, Value_In_Ptr_Array (2).all, Default_Value,
   -- Value_In_Ptr_Array (2).all, Value_In_Ptr_Array (2).all, Default_Value,
   -- Default_Value, Value_In_Ptr_Array (1).all, Default_Value,
   -- Value_In_Ptr_Array (2).all, Value_In_Ptr_Array (2).all, Default_Value
   ...
   My_Index_1 :=
     My_Vector_1.Reverse_Find_Index (Item => Value_In_Ptr_Array (9).all);
