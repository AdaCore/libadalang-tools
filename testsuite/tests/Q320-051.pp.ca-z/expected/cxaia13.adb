...
procedure Cxaia13 is
   ...
   package My_Indefinite_Ordered_Sets is new Ada.Containers
...
begin
   ...
   declare
      ...
      My_Constant_Reference : My_Indefinite_Ordered_Sets
        .Constant_Reference_Type :=
        My_Set_1.Constant_Reference (Position => My_Set_1.First);
   ...
   begin
      ...
      Test
        (Value =>
           My_Indefinite_Ordered_Sets.Constant_Reference
      ...
      Test_And_Mod
        (Value =>
           My_Keys.Reference_Preserving_Key (My_Set_1, Position => My_Cursor_1)
             .Element.all,
         Expected  => "0A",
      ...
      Test
        (Value     => My_Set_1.Constant_Reference (Position => My_Cursor_1),
         Expected  => "00",
         Test_Case => "Constant_Reference generalized cursor");

      -- Object indexing, everything implicit.
      Test
        (Value     => My_Set_1 (My_Cursor_1), -- Constant_Indexing
         Expected  => "00",
      ...
      begin
         ...
         Report.Failed
           ("No exception raised when key changed for " &
      ...
      exception
         when Program_Error =>
            ...
            if not My_Set_1.Is_Empty then
               Report.Failed
                 ("Changed element not removed by " &
   ...
   begin
      ...
      for E of My_Set_1 loop
         ...
         Tampering_Check
           (Container => My_Set_1, Where => "reading forward of loop");
      ...
      for E of reverse My_Set_1 loop
         ...
         Tampering_Check
           (Container => My_Set_1, Where => "reading reverse of loop");
      ...
      for C in My_Set_1.Iterate loop
         ...
         Tampering_Check
           (Container => My_Set_1, Where => "reading forward in loop");
      ...
      for C in reverse My_Set_1.Iterate loop
         ...
         Tampering_Check
           (Container => My_Set_1, Where => "reading reverse in loop");
      ...
      for C in My_Set_1.Iterate (My_Cursor_1) loop
         ...
         Tampering_Check
           (Container => My_Set_1, Where => "reading partial forward in loop");
      ...
      for C in reverse My_Set_1.Iterate (My_Cursor_1) loop
         ...
         Tampering_Check
           (Container => My_Set_1, Where => "reading partial reverse in loop");
      ...
      My_Cursor_1 := My_Set_1.Find (Item => Value_In_Ptr_Array (3).all);
      ...
      if not
        (Early_Total_In =
         (Character'Pos (Value_In_Ptr_Array (1) (1)) +
          Character'Pos (Value_In_Ptr_Array (2) (1)) +
          Character'Pos (Value_In_Ptr_Array (3) (1))))
      then
