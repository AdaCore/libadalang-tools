...
procedure Cxa3006 is
   ...
   begin
      ...
      if Awch.To_Upper (Awch.To_Lower (Uc_Wide_String_2)) /=
        Uc_Wide_String_2 or
...
begin
   ...
   begin
      ...
      if not (Awch.To_Upper ('F') = 'F' and Awch.To_Upper ('U') = 'U') then
      ...
      if Awch.To_Upper (Awch.To_Lower ('A')) /= 'A' then
   ...
   exception
      ...
      when others =>
         Report.Failed ("Exception raised in Wide_Character_Block");
   ...
   exception
      ...
      when others =>
         Report.Failed ("Exception raised in Greek_Wide_Character_Block");
   ...
   exception
      ...
      when others =>
         Report.Failed ("Exception raised in Wide_String_Block");
   ...
   exception
      ...
      when others =>
         Report.Failed ("Exception raised in Greek_Wide_String_Block");
