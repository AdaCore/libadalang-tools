...
begin
   ...
   Report.Test
     ("CXA4026",
      "Check that procedures Trim, Head, and Tail, " &
   ...
   begin
      ...
      if Fixed.Index
          (Source  => "The library package Strings.Fixed",
           Pattern => "fix",
      ...
      if Fixed.Translate
        ...
        Fixed.Translate ("ALL LOWER CASE", Map_To_Lower_Case_Ptr) /=
          "all lower case" or

        Fixed.Translate ("end with lower case", Map_To_Lower_Case_Ptr) /=
          "end with lower case" or

        Fixed.Translate ("", Map_To_Lower_Case_Ptr) /= "" or

        Fixed.Translate ("start with lower case", Map_To_Upper_Case_Ptr) /=
          "START WITH LOWER CASE" or

        Fixed.Translate ("ALL UPPER CASE STRING", Map_To_Upper_Case_Ptr) /=
        ...
        Fixed.Translate (New_Character_String, Map_To_Upper_Case_Ptr) /=
