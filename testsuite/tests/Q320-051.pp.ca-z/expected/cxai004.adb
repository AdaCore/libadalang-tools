...
begin
   ...
   declare
      ...
      My_Map_3 : My_Ordered_Maps.Map := My_Map_1;

      I : Array_Bounds_Type := Array_Bounds_Type'First;

      procedure My_Process (Position : in My_Ordered_Maps.Cursor) is
      begin
      ...
      procedure My_Reverse_Process (Position : in My_Ordered_Maps.Cursor) is
      begin
