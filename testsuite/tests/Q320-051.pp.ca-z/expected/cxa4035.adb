...
procedure Cxa4035 is
   ...
   package Bounded_6 is new Ada.Strings.Bounded.Generic_Bounded_Length (6);
   ...
   function Bounded_6_Equal_Case_Insensitive is new Ada.Strings.Bounded
     .Equal_Case_Insensitive
     (Bounded_6);

   function Bounded_6_Less_Case_Insensitive is new Ada.Strings.Bounded
...
begin
   ...
   if not Ada.Strings.Equal_Case_Insensitive (Lc_String_1, Tc_String_1) then
   ...
   if not Ada.Strings.Equal_Case_Insensitive (Lc_String_1, Uc_String_1) then
   ...
   if not Ada.Strings.Equal_Case_Insensitive (Tc_String_1, Uc_String_1) then
   ...
   if Ada.Strings.Equal_Case_Insensitive (Lc_String_1, Lc_String_2) then
   ...
   if Ada.Strings.Equal_Case_Insensitive (Tc_String_1, Tc_String_2) then
   ...
   if Ada.Strings.Equal_Case_Insensitive (Uc_String_1, Uc_String_2) then
   ...
   if Ada.Strings.Equal_Case_Insensitive (Lc_String_1, Lc_String_3) then
   ...
   if Ada.Strings.Equal_Case_Insensitive (Tc_String_1, Tc_String_3) then
   ...
   if Ada.Strings.Equal_Case_Insensitive (Uc_String_1, Uc_String_3) then
   ...
   if Ada.Strings.Fixed.Equal_Case_Insensitive (Lc_String_1, Lc_String_2) then
   ...
   if Ada.Strings.Fixed.Equal_Case_Insensitive (Tc_String_1, Tc_String_2) then
   ...
   if Ada.Strings.Fixed.Equal_Case_Insensitive (Uc_String_1, Uc_String_2) then
   ...
   if Ada.Strings.Fixed.Equal_Case_Insensitive (Lc_String_1, Lc_String_3) then
   ...
   if Ada.Strings.Fixed.Equal_Case_Insensitive (Tc_String_1, Tc_String_3) then
   ...
   if Ada.Strings.Fixed.Equal_Case_Insensitive (Uc_String_1, Uc_String_3) then
   ...
   if Ada.Strings.Less_Case_Insensitive (Lc_String_1, Tc_String_1) then
   ...
   if Ada.Strings.Less_Case_Insensitive (Lc_String_1, Uc_String_1) then
   ...
   if Ada.Strings.Less_Case_Insensitive (Tc_String_1, Uc_String_1) then
   ...
   if not Ada.Strings.Less_Case_Insensitive (Lc_String_1, Lc_String_2) then
   ...
   if not Ada.Strings.Less_Case_Insensitive (Tc_String_1, Tc_String_2) then
   ...
   if not Ada.Strings.Less_Case_Insensitive (Uc_String_1, Uc_String_2) then
   ...
   if not Ada.Strings.Less_Case_Insensitive (Lc_String_1, Lc_String_3) then
   ...
   if not Ada.Strings.Less_Case_Insensitive (Tc_String_1, Tc_String_3) then
   ...
   if not Ada.Strings.Less_Case_Insensitive (Uc_String_1, Uc_String_3) then
   ...
   if Ada.Strings.Fixed.Less_Case_Insensitive (Lc_String_1, Tc_String_1) then
   ...
   if Ada.Strings.Fixed.Less_Case_Insensitive (Lc_String_1, Uc_String_1) then
   ...
   if Ada.Strings.Fixed.Less_Case_Insensitive (Tc_String_1, Uc_String_1) then
