...
begin
   ...
   begin
      ...
      if Inst.Nt1_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Inst.Nt1");
      end if;
      ...
      if Inst.Nt2_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Inst.Nt2");
      end if;
      ...
      if Inst.Nt3_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Inst.Nt3");
      end if;
      ...
      if Inst.Nt4_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Inst.Nt4");
      end if;
      ...
      if Inst.Nt5_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Inst.Nt5");
      end if;
      ...
      if Inst.Nt6_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Inst.Nt6");
      end if;
      ...
      if Inst.Nt7_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Inst.Nt7");
      end if;
      ...
      if Inst.Nt8_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Inst.Nt8");
      end if;
      ...
      if Inst.Nt9_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Inst.Nt9");
      end if;
      ...
      if Inst.Get_Nt10_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Inst.Nt10");
      end if;
      ...
      if Inst.Nt11_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Inst.Nt11");
      end if;
      ...
      if Inst.Get_Nt12_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Inst.Nt12");
      end if;
      ...
      if Inst.Nt13_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Inst.Nt13");
      end if;
   end Test_Gen;
   ...
   begin
      ...
      if Deriv.Nt1_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Deriv.Nt1");
      end if;
      ...
      if Deriv.Nt2_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Deriv.Nt2");
      end if;
      ...
      if Deriv.Nt3_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Deriv.Nt3");
      end if;
      ...
      if Deriv.Nt4_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Deriv.Nt4");
      end if;
      ...
      if Deriv.Nt5_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Deriv.Nt5");
      end if;
      ...
      if Deriv.Nt6_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Deriv.Nt6");
      end if;
      ...
      if Deriv.Nt7_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Deriv.Nt7");
      end if;
      ...
      if Deriv.Nt8_Ops.Get_Counts /= (1, 1, 1, 1) then
         Failed ("Incorrect calls to the stream attributes for Deriv.Nt8");
      end if;
   end Test_Deriv;
