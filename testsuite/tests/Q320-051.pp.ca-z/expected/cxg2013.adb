...
procedure Cxg2013 is
   ...
   package body Generic_Check is
      ...
      begin
         ...
         for I in 1 .. Max_Samples loop
            ...
            if abs (X - Pi) > ((B - A) / Real (2 * Max_Samples)) then
               Check
                 (Actual1, Actual2,
                  "Tan_Test " & Integer'Image (I) & ": tan(" & Real'Image (X) &
                  ") ",
      ...
      exception
         when Constraint_Error =>
            Report.Failed ("Constraint_Error raised in Tan_Test");
         when others =>
      ...
      begin
         ...
         for I in 1 .. Max_Samples loop
            ...
            Check
              (Actual1, Actual2,
               "Cot_Test " & Integer'Image (I) & ": cot(" & Real'Image (X) &
               ") ",
               (1.0 + Sqrt2) * Maximum_Relative_Error);
            -- see Cody pg 165 for error bound info
      ...
      exception
         when Constraint_Error =>
            Report.Failed ("Constraint_Error raised in Cot_Test");
         when others =>
