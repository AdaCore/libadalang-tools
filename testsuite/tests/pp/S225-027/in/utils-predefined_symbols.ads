...
package Utils.Predefined_Symbols is
   ...
   Last_Reserved_For_Ada_Version : constant array
     (Ada_Version_Type) of Potential_Reserved_Word_Sym :=
     (Ada_83 => Name_Xor, Ada_95 => Name_Tagged, Ada_2005 => Name_Synchronized,
      Ada_2012 => Name_Some);
