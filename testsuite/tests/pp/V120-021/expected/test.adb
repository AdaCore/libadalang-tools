procedure test is
  ...
  type my_very_long_long_named_type_array is
   array (1 .. 10) of my_long_named_type_array;
  ...
  my_very_long_named_anonymus_array_variable :
   array (1 .. 10) of my_long_named_type_array;
  my_very_long_named_anonymus_array_var : my_very_long_long_named_type_array;
  my_very_long_named_anonymus_array_variable :
   constant array (1 .. 10) of my_long_named_type_array :=
   (others => (others => False));

  my_very_long_named_anonymus_array_var_renames :
   my_very_long_long_named_type_array_ren renames
   my_very_long_long_named_type_array;
