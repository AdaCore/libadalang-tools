...
begin
   ...
   for I in reverse Array_Bounds_Type loop
      ...
      if I mod 2 = 0 then
         ...
         My_Cursor_2 :=
           My_Bounded_Multiway_Trees.Previous_Sibling
   ...
   declare
      ...
      procedure My_Reverse_Process
        (Position : in My_Bounded_Multiway_Trees.Cursor)
      is
      begin
      ...
      J =>
        My_Bounded_Multiway_Trees.Previous_Sibling
          (Position =>
             My_Bounded_Multiway_Trees.Previous_Sibling
               (Position =>
                  My_Bounded_Multiway_Trees.Last_Child (Parent => Root_2))));
...
-- Value_In_Array (9), Value_In_Array (10)
   ...
   Second_Child_Cursor_1 :=
     My_Bounded_Multiway_Trees.Next_Sibling (Position => First_Child_Cursor_1);
   ...
   My_Tree_1.Copy_Subtree
     (Parent => First_Child_Cursor_1,
      Before =>
        My_Bounded_Multiway_Trees.Last_Child (Parent => First_Child_Cursor_1),
   ...
   Last_Child_Cursor_1 :=
     My_Bounded_Multiway_Trees.Last_Child (Parent => Root_1);
