...
begin
   ...
   declare
      ...
      package Pkg is
         Form_Discrete_Obj1 : Form_Discrete_Type := Form_Discrete_Type'First;
      private
         for Form_Discrete_Obj1 use at Variable_Address;
      end Pkg;
      ...
      begin
         ...
         if Form_Discrete_Obj1'Address /= Variable_Address then
            Failed ("INCORRECT ADDRESS FOR FORMAL DISCRETE " & "VARIABLE");
         end if;
      end Pkg;
