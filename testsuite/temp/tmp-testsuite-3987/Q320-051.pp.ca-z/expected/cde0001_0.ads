...
package Cde0001_0 is
   ...
   type Rec_Of_Limited_Private is record
      C1 : Limited_Private;
   end record;

   type Rec_Of_Private_Subtype is record
      C1 : Private_Subtype;
   end record;
...
private
   ...
   package Cde0001_2 is
      ...
      procedure Assign_Arrays (P1 : out Formal_Arr01; P2 : out Formal_Arr02);

      procedure Assign_Access (P1 : out Formal_Acc01; P2 : out Formal_Acc02);
   ...
   type New_Tagtype is new Tag_Type with record
      C2 : Private_Type;
   end record;
