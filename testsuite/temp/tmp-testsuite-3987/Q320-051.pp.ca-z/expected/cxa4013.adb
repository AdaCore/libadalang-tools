...
begin
   ...
   Test_Block : declare
      ...
      Wc              : Wide_Character :=
        Wide_Character'Val
          (Character'Pos ('X') + Character'Pos (Character'Last) + 1);
      ...
      function Equivalent (Left : Ws; Right : Wide_String) return Boolean is
      begin
      ...
      is
         ...
         Start_Pos, Index : Natural               := Source_String'First;
