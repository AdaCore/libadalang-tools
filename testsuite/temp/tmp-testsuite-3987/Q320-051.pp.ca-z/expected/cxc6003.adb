...
begin
   ...
   case Integer'Size is
      when 0 .. 15 =>
         Num_Bytes_In_Integer := 1;
      when 16 .. 23 =>
         Num_Bytes_In_Integer := 2;
      when 24 .. 31 =>
         Num_Bytes_In_Integer := 3;
      when 32 .. 39 =>
         Num_Bytes_In_Integer := 4;
      when 40 .. 47 =>
         Num_Bytes_In_Integer := 5;
      when 48 .. 55 =>
         Num_Bytes_In_Integer := 6;
      when 56 .. 63 =>
         Num_Bytes_In_Integer := 7;
      when others =>
         Num_Bytes_In_Integer := 8;
   end case;
   ...
   declare   -- encapsulation
      ...
      for Nibble_Array'Component_Size use Impdef.Annex_C
          .Minimum_Atomic_Component_Size;
   ...
   begin  -- encapsulation
      ...
      if Counter.Value > 0 then
         Report.Failed
           ("assignment to atomic components of array" &
