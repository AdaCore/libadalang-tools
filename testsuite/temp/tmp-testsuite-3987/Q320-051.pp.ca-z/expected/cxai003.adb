...
begin
   ...
   if My_Map_1.Capacity < Num_Tests then
   ...
   if My_Map_2.Capacity < Num_Tests then
   ...
   declare
      ...
      My_Map_3 : My_Hashed_Maps.Map := My_Map_1;

      procedure My_Process (Position : in My_Hashed_Maps.Cursor) is
      begin
...
-- not the order of insertion
   ...
   if My_Hashed_Maps.Equivalent_Keys
       (Left  => My_Map_1.First,
        Right => My_Hashed_Maps.Key (My_Hashed_Maps.Next (My_Map_1.First)))
   then
