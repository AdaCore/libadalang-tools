...
begin
   ...
   Test_Block : declare
      ...
      Def_Radix : constant Character := Ada.Text_Io.Editing.Default_Radix_Mark;
      ...
      Decimal_Data : Decimal_Data_Array_Type (1 .. 5) :=
        (1 => 1_357.99, 2 => -9_029.01, 3 => 0.00, 4 => 0.20, 5 => 3.45);
   ...
   begin
      ...
      if Image_Io.Image (12.34, Pic => Picture_15) /= "$12.34" then
