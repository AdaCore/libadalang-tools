...
--        storage size clause .................. Expressions need not be static
...
--                        version).
--      25 MAR 13   RLB   Storage_Size can be rounded up, so used
--                        new Maximum_Adjustment_To_Specified_Storage_Size
--                        in check.
--      24 MAY 13   RLB   Fixed missing comma in call.
--!
...
--        Expression must be static - RM 13.3(69)
   ...
   for Array_With_Components'
     Component_Size use A_Reasonable_Size_Value;                            -- N/A => ERROR.
