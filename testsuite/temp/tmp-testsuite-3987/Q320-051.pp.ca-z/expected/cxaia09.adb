...
procedure Cxaia09 is
   ...
   package My_Indefinite_Doubly_Linked_Lists is new Ada.Containers
     .Indefinite_Doubly_Linked_Lists
     (Element_Type => String); -- Default =

   package My_Sorting is new My_Indefinite_Doubly_Linked_Lists.Generic_Sorting
...
begin
   ...
   declare
      ...
      My_Constant_Reference : My_Indefinite_Doubly_Linked_Lists
