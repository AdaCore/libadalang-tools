...
package body C851002_A is
   ...
   begin
      Report.Failed
        ("Wrong Element1 routine called -" & Natural'Image (Cursor));
      return (others => <>);
   end Element1;
   ...
   begin
      Report.Failed
        ("Wrong Element2 routine called -" & Natural'Image (Cursor));
      return (others => <>);
   end Element2;
   ...
   begin
      Report.Failed
        ("Wrong Element3 routine called -" & Natural'Image (Cursor));
      return (others => <>);
   end Element3;
