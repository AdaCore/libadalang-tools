...
procedure C760010 is
   ...
   begin
      Report.Failed
        (Message & " for case " & C760010_0.Actions'Image (C760010_0.Action));
   end Case_Failure;
   ...
   begin
      ...
      begin
         ...
         if C760010_0.Action in
             C760010_0.Adj_Raise_User_Defined .. C760010_0.Fin_Raise_Standard
         then
            Case_Failure ("Anticipated exception at assignment");
         end if;
      exception
         when Program_Error =>
            if C760010_0.Action not in
                C760010_0.Adj_Raise_User_Defined ..
                      C760010_0.Fin_Raise_Standard
            then
...
---------------------------------------------------------------------------
   ...
   begin
      begin
         ...
         if C760010_0.Action in
             C760010_0.Adj_Raise_User_Defined .. C760010_0.Adj_Raise_Standard
         then
...
---------------------------------------------------------------------------
   ...
   begin
      begin
         ...
         if C760010_0.Action in
             C760010_0.Fin_Raise_User_Defined .. C760010_0.Fin_Raise_Standard
         then
...
begin  -- Main test procedure.
   ...
   Report.Test
     ("C760010",
      "Check that explicit calls to finalization " &
   ...
   for Act in C760010_0.Actions loop
      ...
      exception
         ...
         when Program_Error =>
            ...
            -- 7.6.1:14
            if Act not in
                C760010_0.Fin_Raise_User_Defined ..
                      C760010_0.Fin_Raise_Standard
            then
