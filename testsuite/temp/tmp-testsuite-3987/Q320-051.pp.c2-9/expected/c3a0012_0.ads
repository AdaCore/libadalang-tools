...
package C3a0012_0 is
   ...
   type Call_Kind is
     (No_Call_Made, Fast_Call, Accurate_Call, Table_Lookup_Call);
   ...
   procedure Log_Calc_Acc (Angle : in Float; Method : out Call_Kind);

   procedure Log_Calc_Table (Angle : in Float; Method : out Call_Kind);
