...
package C391002_4 is -- Communications
   ...
   type Public_Comm is new Modules.Electronics_Module with record
      Tc_Vc : Integer;
   end record;
   ...
   procedure Creator
     (Plugs : in     Modules.Electronics_Module;
      Gives :    out Mil_Comm);
...
private
   type Private_Comm is new Modules.Electronics_Module with record
      Tc_Pc : Integer;
   end record;

   type Mil_Comm is new Modules.Electronics_Module with record
      Tc_Mc : Integer;
   end record;
