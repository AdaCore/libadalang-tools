...
package LAL_UL.Command_Lines is
   ...
   --  See LAL_UL.Common for an example of Step 1, and see LAL_UL.Projects for
   ...
   package String_Access_Vectors is new ASIS_UL.Vectors
     (Positive,
   ...
   --  LAL_UL.Projects), it is called on the command-line arguments, then on
...
private
   ...
   package Switch_Descriptor_Vectors is new ASIS_UL.Vectors
     (All_Switches,
      Switch_Descriptor,
