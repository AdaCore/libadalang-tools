...
package Stub.Command_Lines is
   ...
   package Stub_Flag_Shorthands is new
     Stub_Flag_Switches.Set_Shorthands
       ([Subunits                    => null,
         Force                       => +"-f",
   ...
   package Stub_String_Switches is new
     String_Switches (Descriptor, Stub_Strings);

   package Stub_String_Syntax is new
     Stub_String_Switches.Set_Syntax ([Header_File => '=', Output => '=']);

   package Stub_String_Shorthands is new
     Stub_String_Switches.Set_Shorthands
   ...
   package Stub_Nat_Switches is new
     Other_Switches
       (Descriptor,
        Stub_Nats,
        Natural,
   ...
   package Stub_Nat_Syntax is new
     Stub_Nat_Switches.Set_Syntax
       ([Max_Line_Length => '!', Indentation => '!', Update_Body => '=']);

   No_Update_Body : constant Natural := 0;

   package Stub_Nat_Defaults is new
     Stub_Nat_Switches.Set_Defaults
       ([Max_Line_Length => 79,
         Indentation     => 3,
         Update_Body     => No_Update_Body]);

   package Stub_Nat_Shorthands is new
     Stub_Nat_Switches.Set_Shorthands
       ([Max_Line_Length => +"-gnatyM",
         Indentation     => +"-gnaty",
         Update_Body     => null]);

   package Stub_Nat_Shorthands_2 is new
     Stub_Nat_Switches.Set_Shorthands
   ...
   function Update_Body_Specified (Cmd : Cmd_Line) return Boolean
   is (Arg (Cmd, Update_Body) /= No_Update_Body);
