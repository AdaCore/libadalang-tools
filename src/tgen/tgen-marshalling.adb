...
package body TGen.Marshalling is
      ...
      for Cu in D_Typ.Discriminant_Types.Iterate loop
         declare
            ...
            Discr_Typ  : constant String :=
              (Component_Maps.Element (Cu).Get.FQN);
   ...
   is
      B_Name         : constant String := Typ.FQN;
      ...
      is
         ...
         Discr_Typ_FQN : constant String := Discr_Typ.Get.FQN;
